...
static t_nubit32 _GetCode(t_nubit32 offset, t_nubit8 byte) {
    ...
    switch (byte) {
    case 1:
        return vramByte(physical);
    case 2:
        return vramWord(physical);
    case 4:
        return vramDWord(physical);
    case 6:
        return GetMax48(vramQWord(physical));
    case 8:
        return vramQWord(physical);
    default:
        CaseError("_GetCode::byte");
        return 0x00000000;
    }
    return 0x00000000;
}
...
static t_cpu_sreg *_GetPtrOverrideDS() {
    ...
    case PREFIX_SREG_GS:
        ...
        break;
    default:
        CaseError("_GetPtrOverrideDS::prefix_sreg");
        break;
    }
    return pds;
}
static t_cpu_sreg *_GetPtrOverrideSS() {
    ...
    case PREFIX_SREG_GS:
        ...
        break;
    default:
        CaseError("_GetPtrOverrideSS::prefix_sreg");
        break;
    }
    return pss;
}
...
static void _GetModRegRM(t_nubit8 regbit, t_nubit8 rmbit, t_bool write) {
    ...
    if (_GetAddressSize == 16) {
        ...
        case 0:
            ...
            case 0:
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(vcpu.bx+vcpu.si), rmbyte, write, 0x00);
                break;
            case 1:
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(vcpu.bx+vcpu.di), rmbyte, write, 0x00);
                break;
            case 2:
                vcpuins.lrm = _GetLinearFromLogical(pss, GetMax16(vcpu.bp+vcpu.si), rmbyte, write, 0x00);
                break;
            case 3:
                vcpuins.lrm = _GetLinearFromLogical(pss, GetMax16(vcpu.bp+vcpu.di), rmbyte, write, 0x00);
                break;
            case 4:
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(vcpu.si), rmbyte, write, 0x00);
                break;
            case 5:
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(vcpu.di), rmbyte, write, 0x00);
                break;
            case 6:
                disp16 = (t_nubit16)_GetCode(vcpu.eip, 2);
                _CheckExcept("_GetModRegRM::AddressSize(16)::ModRM_MOD(0)::ModRM_RM(6)::_GetCode");
                vcpu.eip += 2;
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(disp16),  rmbyte, write, 0x00);
                break;
            case 7:
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(vcpu.bx), rmbyte, write, 0x00);
                break;
            default:
                CaseError("_GetModRegRM::AddressSize(16)::ModRM_MOD(0)::ModRM_RM");
                return;
            }
        ...
        case 1:
            ...
            switch (_GetModRM_RM(modrm)) {
            case 0:
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(vcpu.bx+vcpu.si+disp8), rmbyte, write, 0x00);
                break;
            case 1:
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(vcpu.bx+vcpu.di+disp8), rmbyte, write, 0x00);
                break;
            case 2:
                vcpuins.lrm = _GetLinearFromLogical(pss, GetMax16(vcpu.bp+vcpu.si+disp8), rmbyte, write, 0x00);
                break;
            case 3:
                vcpuins.lrm = _GetLinearFromLogical(pss, GetMax16(vcpu.bp+vcpu.di+disp8), rmbyte, write, 0x00);
                break;
            case 4:
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(vcpu.si+disp8), rmbyte, write, 0x00);
                break;
            case 5:
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(vcpu.di+disp8), rmbyte, write, 0x00);
                break;
            case 6:
                vcpuins.lrm = _GetLinearFromLogical(pss, GetMax16(vcpu.bp+disp8), rmbyte, write, 0x00);
                break;
            case 7:
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(vcpu.bx+disp8), rmbyte, write, 0x00);
                break;
            default:
                CaseError("_GetModRegRM::AddressSize(16)::ModRM_MOD(1)::ModRM_RM");
                return;
            }
        ...
        case 2:
            ...
            switch (_GetModRM_RM(modrm)) {
            case 0:
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(vcpu.bx+vcpu.si+disp16), rmbyte, write, 0x00);
                break;
            case 1:
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(vcpu.bx+vcpu.di+disp16), rmbyte, write, 0x00);
                break;
            case 2:
                vcpuins.lrm = _GetLinearFromLogical(pss, GetMax16(vcpu.bp+vcpu.si+disp16), rmbyte, write, 0x00);
                break;
            case 3:
                vcpuins.lrm = _GetLinearFromLogical(pss, GetMax16(vcpu.bp+vcpu.di+disp16), rmbyte, write, 0x00);
                break;
            case 4:
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(vcpu.si+disp16), rmbyte, write, 0x00);
                break;
            case 5:
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(vcpu.di+disp16), rmbyte, write, 0x00);
                break;
            case 6:
                vcpuins.lrm = _GetLinearFromLogical(pss, GetMax16(vcpu.bp+disp16), rmbyte, write, 0x00);
                break;
            case 7:
                vcpuins.lrm = _GetLinearFromLogical(pds, GetMax16(vcpu.bx+disp16), rmbyte, write, 0x00);
                break;
            default:
                CaseError("_GetModRegRM::AddressSize(16)::ModRM_MOD(2)::ModRM_RM");
                return;
            }
        ...
        if (_GetModRM_MOD(modrm) != 3 && _GetModRM_RM(modrm) == 4) {
            ...
            case 7:
                ...
                break;
            default:
                CaseError("_GetModRegRM::AddressSize(32)::ModRM_MOD(!3)::ModRM_RM(4)::SIB_Index");
                return;
            }
        ...
        case 0:
            switch (_GetModRM_RM(modrm)) {
            case 0:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.eax, rmbyte, write, 0x00);
                break;
            case 1:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.ecx, rmbyte, write, 0x00);
                break;
            case 2:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.edx, rmbyte, write, 0x00);
                break;
            case 3:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.ebx, rmbyte, write, 0x00);
                break;
            case 4:
                switch (_GetSIB_Base(sib)) {
                case 0:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.eax + sibindex, rmbyte, write, 0x00);
                    break;
                case 1:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.ecx + sibindex, rmbyte, write, 0x00);
                    break;
                case 2:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.edx + sibindex, rmbyte, write, 0x00);
                    break;
                case 3:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.ebx + sibindex, rmbyte, write, 0x00);
                    break;
                case 4:
                    vcpuins.lrm = _GetLinearFromLogical(pss, vcpu.esp + sibindex, rmbyte, write, 0x00);
                    break;
                case 5:
                    ...
                    break;
                case 6:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.esi + sibindex, rmbyte, write, 0x00);
                    break;
                case 7:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.edi + sibindex, rmbyte, write, 0x00);
                    break;
                default:
                    CaseError("_GetModRegRM::AddressSize(32)::ModRM_MOD(0)::ModRM_RM(4)::SIB_Base");
                    return;
                }
                break;
            case 5:
                ...
                break;
            case 6:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.esi, rmbyte, write, 0x00);
                break;
            case 7:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.edi, rmbyte, write, 0x00);
                break;
            default:
                CaseError("_GetModRegRM::AddressSize(32)::ModRM_MOD(0)::ModRM_RM");
                return;
            }
        ...
        case 1:
            ...
            switch (_GetModRM_RM(modrm)) {
            case 0:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.eax + disp8, rmbyte, write, 0x00);
                break;
            case 1:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.ecx + disp8, rmbyte, write, 0x00);
                break;
            case 2:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.edx + disp8, rmbyte, write, 0x00);
                break;
            case 3:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.ebx + disp8, rmbyte, write, 0x00);
                break;
            case 4:
                switch (_GetSIB_Base(sib)) {
                case 0:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.eax + sibindex + disp8, rmbyte, write, 0x00);
                    break;
                case 1:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.ecx + sibindex + disp8, rmbyte, write, 0x00);
                    break;
                case 2:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.edx + sibindex + disp8, rmbyte, write, 0x00);
                    break;
                case 3:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.ebx + sibindex + disp8, rmbyte, write, 0x00);
                    break;
                case 4:
                    vcpuins.lrm = _GetLinearFromLogical(pss, vcpu.esp + sibindex + disp8, rmbyte, write, 0x00);
                    break;
                case 5:
                    vcpuins.lrm = _GetLinearFromLogical(pss, vcpu.ebp + sibindex + disp8, rmbyte, write, 0x00);
                    break;
                case 6:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.esi + sibindex + disp8, rmbyte, write, 0x00);
                    break;
                case 7:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.edi + sibindex + disp8, rmbyte, write, 0x00);
                    break;
                default:
                    CaseError("_GetModRegRM::AddressSize(32)::ModRM_MOD(1)::ModRM_RM(4)::SIB_Base");
                    return;
                }
                break;
            case 5:
                vcpuins.lrm = _GetLinearFromLogical(pss, vcpu.ebp + disp8, rmbyte, write, 0x00);
                break;
            case 6:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.esi + disp8, rmbyte, write, 0x00);
                break;
            case 7:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.edi + disp8, rmbyte, write, 0x00);
                break;
            default:
                CaseError("_GetModRegRM::AddressSize(32)::ModRM_MOD(1)::ModRM_RM");
                return;
            }
        ...
        case 2:
            ...
            switch (_GetModRM_RM(modrm)) {
            case 0:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.eax + disp32, rmbyte, write, 0x00);
                break;
            case 1:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.ecx + disp32, rmbyte, write, 0x00);
                break;
            case 2:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.edx + disp32, rmbyte, write, 0x00);
                break;
            case 3:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.ebx + disp32, rmbyte, write, 0x00);
                break;
            case 4:
                switch (_GetSIB_Base(sib)) {
                case 0:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.eax + sibindex + disp32, rmbyte, write, 0x00);
                    break;
                case 1:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.ecx + sibindex + disp32, rmbyte, write, 0x00);
                    break;
                case 2:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.edx + sibindex + disp32, rmbyte, write, 0x00);
                    break;
                case 3:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.ebx + sibindex + disp32, rmbyte, write, 0x00);
                    break;
                case 4:
                    vcpuins.lrm = _GetLinearFromLogical(pss, vcpu.esp + sibindex + disp32, rmbyte, write, 0x00);
                    break;
                case 5:
                    vcpuins.lrm = _GetLinearFromLogical(pss, vcpu.ebp + sibindex + disp32, rmbyte, write, 0x00);
                    break;
                case 6:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.esi + sibindex + disp32, rmbyte, write, 0x00);
                    break;
                case 7:
                    vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.edi + sibindex + disp32, rmbyte, write, 0x00);
                    break;
                default:
                    CaseError("_GetModRegRM::AddressSize(32)::ModRM_MOD(2)::ModRM_RM(4)::SIB_Base");
                    return;
                }
                break;
            case 5:
                vcpuins.lrm = _GetLinearFromLogical(pss, vcpu.ebp + disp32, rmbyte, write, 0x00);
                break;
            case 6:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.esi + disp32, rmbyte, write, 0x00);
                break;
            case 7:
                vcpuins.lrm = _GetLinearFromLogical(pds, vcpu.edi + disp32, rmbyte, write, 0x00);
                break;
            default:
                CaseError("_GetModRegRM::AddressSize(32)::ModRM_MOD(2)::ModRM_RM");
                return;
            }
    ...
    if (_GetModRM_MOD(modrm) == 3) {
        ...
        case 1:
            switch (_GetModRM_RM(modrm)) {
            case 0:
                vcpuins.prm = (t_vaddrcc)(&vcpu.al);
                break;
            case 1:
                vcpuins.prm = (t_vaddrcc)(&vcpu.cl);
                break;
            case 2:
                vcpuins.prm = (t_vaddrcc)(&vcpu.dl);
                break;
            case 3:
                vcpuins.prm = (t_vaddrcc)(&vcpu.bl);
                break;
            case 4:
                vcpuins.prm = (t_vaddrcc)(&vcpu.ah);
                break;
            case 5:
                vcpuins.prm = (t_vaddrcc)(&vcpu.ch);
                break;
            case 6:
                vcpuins.prm = (t_vaddrcc)(&vcpu.dh);
                break;
            case 7:
                vcpuins.prm = (t_vaddrcc)(&vcpu.bh);
                break;
            default:
                CaseError("_GetModRegRM::ModRM_MOD(3)::rmbyte(1)::ModRM_RM");
                return;
            }
            break;
        case 2:
            switch (_GetModRM_RM(modrm)) {
            case 0:
                vcpuins.prm = (t_vaddrcc)(&vcpu.ax);
                break;
            case 1:
                vcpuins.prm = (t_vaddrcc)(&vcpu.cx);
                break;
            case 2:
                vcpuins.prm = (t_vaddrcc)(&vcpu.dx);
                break;
            case 3:
                vcpuins.prm = (t_vaddrcc)(&vcpu.bx);
                break;
            case 4:
                vcpuins.prm = (t_vaddrcc)(&vcpu.sp);
                break;
            case 5:
                vcpuins.prm = (t_vaddrcc)(&vcpu.bp);
                break;
            case 6:
                vcpuins.prm = (t_vaddrcc)(&vcpu.si);
                break;
            case 7:
                vcpuins.prm = (t_vaddrcc)(&vcpu.di);
                break;
            default:
                CaseError("_GetModRegRM::ModRM_MOD(3)::rmbyte(2)::ModRM_RM");
                return;
            }
            break;
        case 4:
            switch (_GetModRM_RM(modrm)) {
            case 0:
                vcpuins.prm = (t_vaddrcc)(&vcpu.eax);
                break;
            case 1:
                vcpuins.prm = (t_vaddrcc)(&vcpu.ecx);
                break;
            case 2:
                vcpuins.prm = (t_vaddrcc)(&vcpu.edx);
                break;
            case 3:
                vcpuins.prm = (t_vaddrcc)(&vcpu.ebx);
                break;
            case 4:
                vcpuins.prm = (t_vaddrcc)(&vcpu.esp);
                break;
            case 5:
                vcpuins.prm = (t_vaddrcc)(&vcpu.ebp);
                break;
            case 6:
                vcpuins.prm = (t_vaddrcc)(&vcpu.esi);
                break;
            case 7:
                vcpuins.prm = (t_vaddrcc)(&vcpu.edi);
                break;
            default:
                CaseError("_GetModRegRM::ModRM_MOD(3)::rmbyte(4)::ModRM_RM");
                return;
            }
            break;
        case 6:
    ...
    case 1:
        ...
        case 0:
            vcpuins.pr = (t_vaddrcc)(&vcpu.al);
            break;
        case 1:
            vcpuins.pr = (t_vaddrcc)(&vcpu.cl);
            break;
        case 2:
            vcpuins.pr = (t_vaddrcc)(&vcpu.dl);
            break;
        case 3:
            vcpuins.pr = (t_vaddrcc)(&vcpu.bl);
            break;
        case 4:
            vcpuins.pr = (t_vaddrcc)(&vcpu.ah);
            break;
        case 5:
            vcpuins.pr = (t_vaddrcc)(&vcpu.ch);
            break;
        case 6:
            vcpuins.pr = (t_vaddrcc)(&vcpu.dh);
            break;
        case 7:
            vcpuins.pr = (t_vaddrcc)(&vcpu.bh);
            break;
        default:
            CaseError("_GetModRegRM::regbyte(1)::ModRM_REG");
            return;
        }
        break;
    case 2:
        switch (_GetModRM_REG(modrm)) {
        case 0:
            vcpuins.pr = (t_vaddrcc)(&vcpu.ax);
            break;
        case 1:
            vcpuins.pr = (t_vaddrcc)(&vcpu.cx);
            break;
        case 2:
            vcpuins.pr = (t_vaddrcc)(&vcpu.dx);
            break;
        case 3:
            vcpuins.pr = (t_vaddrcc)(&vcpu.bx);
            break;
        case 4:
            vcpuins.pr = (t_vaddrcc)(&vcpu.sp);
            break;
        case 5:
            vcpuins.pr = (t_vaddrcc)(&vcpu.bp);
            break;
        case 6:
            vcpuins.pr = (t_vaddrcc)(&vcpu.si);
            break;
        case 7:
            vcpuins.pr = (t_vaddrcc)(&vcpu.di);
            break;
        default:
            CaseError("_GetModRegRM::regbyte(2)::ModRM_REG");
            return;
        }
        break;
    case 4:
        switch (_GetModRM_REG(modrm)) {
        case 0:
            vcpuins.pr = (t_vaddrcc)(&vcpu.eax);
            break;
        case 1:
            vcpuins.pr = (t_vaddrcc)(&vcpu.ecx);
            break;
        case 2:
            vcpuins.pr = (t_vaddrcc)(&vcpu.edx);
            break;
        case 3:
            vcpuins.pr = (t_vaddrcc)(&vcpu.ebx);
            break;
        case 4:
            vcpuins.pr = (t_vaddrcc)(&vcpu.esp);
            break;
        case 5:
            vcpuins.pr = (t_vaddrcc)(&vcpu.ebp);
            break;
        case 6:
            vcpuins.pr = (t_vaddrcc)(&vcpu.esi);
            break;
        case 7:
            vcpuins.pr = (t_vaddrcc)(&vcpu.edi);
            break;
        default:
            CaseError("_GetModRegRM::regbyte(4)::ModRM_REG");
            return;
        }
        break;
    default:
...
static void GetModRegRM(t_nubitcc regbit,t_nubitcc rmbit) {
    ...
    case 0:
        switch (_GetModRM_RM(modrm)) {
        case 0:
            vcpuins.rm = vramGetRealAddress(overds->selector,vcpu.bx+vcpu.si);
            break;
        case 1:
            vcpuins.rm = vramGetRealAddress(overds->selector,vcpu.bx+vcpu.di);
            break;
        case 2:
            vcpuins.rm = vramGetRealAddress(overss->selector,vcpu.bp+vcpu.si);
            break;
        case 3:
            vcpuins.rm = vramGetRealAddress(overss->selector,vcpu.bp+vcpu.di);
            break;
        case 4:
            vcpuins.rm = vramGetRealAddress(overds->selector,vcpu.si);
            break;
        case 5:
            vcpuins.rm = vramGetRealAddress(overds->selector,vcpu.di);
            break;
        case 6:
            disp16 = vramVarWord(vcpu.cs.selector,vcpu.eip);
            vcpu.eip += 2;
            vcpuins.rm = vramGetRealAddress(overds->selector,disp16);
            break;
        case 7:
            vcpuins.rm = vramGetRealAddress(overds->selector,vcpu.bx);
            break;
        default:
            CaseError("GetModRegRM::MOD0::ModRM_RM");
            break;
        }
        break;
    case 1:
        bugfix(23) {
            disp8 = (t_nsbit8)vramVarByte(vcpu.cs.selector,vcpu.eip);
            vcpu.eip += 1;
        }
        switch (_GetModRM_RM(modrm)) {
        case 0:
            vcpuins.rm = vramGetRealAddress(overds->selector,vcpu.bx+vcpu.si+disp8);
            break;
        case 1:
            vcpuins.rm = vramGetRealAddress(overds->selector,vcpu.bx+vcpu.di+disp8);
            break;
        case 2:
            vcpuins.rm = vramGetRealAddress(overss->selector,vcpu.bp+vcpu.si+disp8);
            break;
        case 3:
            vcpuins.rm = vramGetRealAddress(overss->selector,vcpu.bp+vcpu.di+disp8);
            break;
        case 4:
            vcpuins.rm = vramGetRealAddress(overds->selector,vcpu.si+disp8);
            break;
        case 5:
            vcpuins.rm = vramGetRealAddress(overds->selector,vcpu.di+disp8);
            break;
        case 6:
            vcpuins.rm = vramGetRealAddress(overss->selector,vcpu.bp+disp8);
            break;
        case 7:
            vcpuins.rm = vramGetRealAddress(overds->selector,vcpu.bx+disp8);
            break;
        default:
            CaseError("GetModRegRM::MOD1::ModRM_RM");
            break;
        }
        bugfix(23) ;
        else {
    ...
    case 2:
        ...
        switch (_GetModRM_RM(modrm)) {
        case 0:
            vcpuins.rm = vramGetRealAddress(overds->selector,vcpu.bx+vcpu.si+disp16);
            break;
        case 1:
            vcpuins.rm = vramGetRealAddress(overds->selector,vcpu.bx+vcpu.di+disp16);
            break;
        case 2:
            vcpuins.rm = vramGetRealAddress(overss->selector,vcpu.bp+vcpu.si+disp16);
            break;
        case 3:
            vcpuins.rm = vramGetRealAddress(overss->selector,vcpu.bp+vcpu.di+disp16);
            break;
        case 4:
            vcpuins.rm = vramGetRealAddress(overds->selector,vcpu.si+disp16);
            break;
        case 5:
            vcpuins.rm = vramGetRealAddress(overds->selector,vcpu.di+disp16);
            break;
        case 6:
            vcpuins.rm = vramGetRealAddress(overss->selector,vcpu.bp+disp16);
            break;
        case 7:
            vcpuins.rm = vramGetRealAddress(overds->selector,vcpu.bx+disp16);
            break;
        default:
            CaseError("GetModRegRM::MOD2::ModRM_RM");
            break;
        }
        bugfix(23) ;
        else {
            vcpuins.rm += vramVarWord(vcpu.cs.selector,vcpu.eip);
            vcpu.eip += 2;
        }
        break;
    case 3:
        switch (_GetModRM_RM(modrm)) {
        case 0:
            if (rmbit == 8) vcpuins.rm = (t_vaddrcc)(&vcpu.al);
            else vcpuins.rm = (t_vaddrcc)(&vcpu.ax);
            break;
        case 1:
            if (rmbit == 8) vcpuins.rm = (t_vaddrcc)(&vcpu.cl);
            else vcpuins.rm = (t_vaddrcc)(&vcpu.cx);
            break;
        case 2:
            if (rmbit == 8) vcpuins.rm = (t_vaddrcc)(&vcpu.dl);
            else vcpuins.rm = (t_vaddrcc)(&vcpu.dx);
            break;
        case 3:
            if (rmbit == 8) vcpuins.rm = (t_vaddrcc)(&vcpu.bl);
            else vcpuins.rm = (t_vaddrcc)(&vcpu.bx);
            break;
        case 4:
            if (rmbit == 8) vcpuins.rm = (t_vaddrcc)(&vcpu.ah);
            else vcpuins.rm = (t_vaddrcc)(&vcpu.sp);
            break;
        case 5:
            if (rmbit == 8) vcpuins.rm = (t_vaddrcc)(&vcpu.ch);
            else vcpuins.rm = (t_vaddrcc)(&vcpu.bp);
            break;
        case 6:
            if (rmbit == 8) vcpuins.rm = (t_vaddrcc)(&vcpu.dh);
            else vcpuins.rm = (t_vaddrcc)(&vcpu.si);
            break;
        case 7:
            if (rmbit == 8) vcpuins.rm = (t_vaddrcc)(&vcpu.bh);
            else vcpuins.rm = (t_vaddrcc)(&vcpu.di);
            break;
        default:
            CaseError("GetModRegRM::MOD3::ModRM_RM");
            break;
        }
        break;
    default:
        CaseError("GetModRegRM::ModRM_MOD");
        break;
    }
    switch (regbit) {
    case 0:
        vcpuins.r = _GetModRM_REG(modrm);
        break;
    case 4:
        switch (_GetModRM_REG(modrm)) {
        case 0:
            vcpuins.r = (t_vaddrcc)(&vcpu.es.selector);
            break;
        case 1:
            vcpuins.r = (t_vaddrcc)(&vcpu.cs.selector);
            break;
        case 2:
            vcpuins.r = (t_vaddrcc)(&vcpu.ss.selector);
            break;
        case 3:
            vcpuins.r = (t_vaddrcc)(&vcpu.ds.selector);
            break;
        case 4:
            vcpuins.r = (t_vaddrcc)(&vcpu.fs.selector);
            break;
        case 5:
            vcpuins.r = (t_vaddrcc)(&vcpu.gs.selector);
            break;
        default:
            CaseError("GetModRegRM::regbit4::ModRM_REG");
            break;
        }
        break;
    case 8:
        switch (_GetModRM_REG(modrm)) {
        case 0:
            vcpuins.r = (t_vaddrcc)(&vcpu.al);
            break;
        case 1:
            vcpuins.r = (t_vaddrcc)(&vcpu.cl);
            break;
        case 2:
            vcpuins.r = (t_vaddrcc)(&vcpu.dl);
            break;
        case 3:
            vcpuins.r = (t_vaddrcc)(&vcpu.bl);
            break;
        case 4:
            vcpuins.r = (t_vaddrcc)(&vcpu.ah);
            break;
        case 5:
            vcpuins.r = (t_vaddrcc)(&vcpu.ch);
            break;
        case 6:
            vcpuins.r = (t_vaddrcc)(&vcpu.dh);
            break;
        case 7:
            vcpuins.r = (t_vaddrcc)(&vcpu.bh);
            break;
        default:
            CaseError("GetModRegRM::regbit8::ModRM_REG");
            break;
        }
        break;
    case 16:
        switch (_GetModRM_REG(modrm)) {
        case 0:
            vcpuins.r = (t_vaddrcc)(&vcpu.ax);
            break;
        case 1:
            vcpuins.r = (t_vaddrcc)(&vcpu.cx);
            break;
        case 2:
            vcpuins.r = (t_vaddrcc)(&vcpu.dx);
            break;
        case 3:
            vcpuins.r = (t_vaddrcc)(&vcpu.bx);
            break;
        case 4:
            vcpuins.r = (t_vaddrcc)(&vcpu.sp);
            break;
        case 5:
            vcpuins.r = (t_vaddrcc)(&vcpu.bp);
            break;
        case 6:
            vcpuins.r = (t_vaddrcc)(&vcpu.si);
            break;
        case 7:
            vcpuins.r = (t_vaddrcc)(&vcpu.di);
            break;
        default:
            CaseError("GetModRegRM::regbit16::ModRM_REG");
            break;
        }
        break;
    default:
...
static void GetModRegRMEA() {
    ...
    case 0:
        switch (_GetModRM_RM(modrm)) {
        case 0:
            vcpuins.rm = vcpu.bx+vcpu.si;
            break;
        case 1:
            vcpuins.rm = vcpu.bx+vcpu.di;
            break;
        case 2:
            vcpuins.rm = vcpu.bp+vcpu.si;
            break;
        case 3:
            vcpuins.rm = vcpu.bp+vcpu.di;
            break;
        case 4:
            vcpuins.rm = vcpu.si;
            break;
        ...
        case 7:
            ...
            break;
        default:
            CaseError("GetModRegRMEA::MOD0::ModRM_RM");
            break;
        }
        break;
    case 1:
        ...
        switch (_GetModRM_RM(modrm)) {
        case 0:
            vcpuins.rm = vcpu.bx+vcpu.si+disp8;
            break;
        case 1:
            vcpuins.rm = vcpu.bx+vcpu.di+disp8;
            break;
        case 2:
            vcpuins.rm = vcpu.bp+vcpu.si+disp8;
            break;
        case 3:
            vcpuins.rm = vcpu.bp+vcpu.di+disp8;
            break;
        case 4:
            vcpuins.rm = vcpu.si+disp8;
            break;
        case 5:
            vcpuins.rm = vcpu.di+disp8;
            break;
        case 6:
            vcpuins.rm = vcpu.bp+disp8;
            break;
        case 7:
            vcpuins.rm = vcpu.bx+disp8;
            break;
        default:
            CaseError("GetModRegRMEA::MOD1::ModRM_RM");
            break;
        }
        bugfix(23) {
            vcpuins.rm %= 0x10000;
    ...
    case 2:
        ...
        switch (_GetModRM_RM(modrm)) {
        case 0:
            vcpuins.rm = vcpu.bx+vcpu.si+disp16;
            break;
        case 1:
            vcpuins.rm = vcpu.bx+vcpu.di+disp16;
            break;
        case 2:
            vcpuins.rm = vcpu.bp+vcpu.si+disp16;
            break;
        case 3:
            vcpuins.rm = vcpu.bp+vcpu.di+disp16;
            break;
        case 4:
            vcpuins.rm = vcpu.si+disp16;
            break;
        case 5:
            vcpuins.rm = vcpu.di+disp16;
            break;
        case 6:
            ...
            break;
        case 7:
            vcpuins.rm = vcpu.bx+disp16;
            break;
        default:
            CaseError("GetModRegRMEA::MOD2::ModRM_RM");
            break;
        }
        bugfix(23) {
            vcpuins.rm %= 0x10000;
        ...
        break;
    default:
        CaseError("GetModRegRMEA::ModRM_MOD");
        break;
    }
    switch (_GetModRM_REG(modrm)) {
    case 0:
    ...
    case 7:
        ...
        break;
    default:
        CaseError("GetModRegRMEA::ModRM_REG");
        break;
    }
}
...
DONE _Push(t_vaddrcc psrc, t_nubit8 bit) {
    ...
    switch (bit) {
    case 16:
        if (vcpu.esp && vcpu.esp < 0x0000002) {
            _SetExcept_SS(0);
        ...
        break;
    case 32:
        if (vcpu.esp && vcpu.esp < 0x0000004) {
            _SetExcept_SS(0);
...
DONE ADD_AX_I16() {
    i386(0x05) {
        ...
        case 32:
            ...
            break;
        default:
            CaseError("ADC_AX_I16::OperandSize");
            return;
        }
    }
    else {
...
DONE INS_80() {
    i386(0x80) {
        ...
        switch (vcpuins.pr) {
        case 0:
            ADD(vcpuins.prm, vcpuins.pimm, 8);
            break;
        case 1:
            OR ((void *)vcpuins.prm, (void *)vcpuins.pimm, 8);
            break;
        case 2:
            ADC(vcpuins.prm, vcpuins.pimm, 8);
            break;
        case 3:
            SBB((void *)vcpuins.prm, (void *)vcpuins.pimm, 8);
            break;
        case 4:
            AND(vcpuins.prm, vcpuins.pimm, 8);
            break;
        case 5:
            SUB((void *)vcpuins.prm, (void *)vcpuins.pimm, 8);
            break;
        case 6:
            XOR((void *)vcpuins.prm, (void *)vcpuins.pimm, 8);
            break;
        case 7:
            CMP((void *)vcpuins.prm, (void *)vcpuins.pimm, 8);
            break;
        default:
            CaseError("INS_80::vcpuins.pr");
            break;
        }
    }
    else {
        ...
        switch (vcpuins.r) {
        case 0:
            ADD(vcpuins.rm, vcpuins.imm, 8);
            break;
        case 1:
            OR ((void *)vcpuins.rm, (void *)vcpuins.imm, 8);
            break;
        case 2:
            ADC(vcpuins.rm, vcpuins.imm, 8);
            break;
        case 3:
            SBB((void *)vcpuins.rm, (void *)vcpuins.imm, 8);
            break;
        case 4:
            AND(vcpuins.rm, vcpuins.imm, 8);
            break;
        case 5:
            SUB((void *)vcpuins.rm, (void *)vcpuins.imm, 8);
            break;
        case 6:
            XOR((void *)vcpuins.rm, (void *)vcpuins.imm, 8);
            break;
        case 7:
            CMP((void *)vcpuins.rm, (void *)vcpuins.imm, 8);
            break;
        default:
            CaseError("INS_80::vcpuins.r");
            break;
        }
    }
}
DONE INS_81() {
    i386(0x81) {
        ...
        switch (vcpuins.pr) {
        case 0:
            ADD(vcpuins.prm, vcpuins.pimm, _GetOperandSize);
            break;
        case 1:
            OR ((void *)vcpuins.prm, (void *)vcpuins.pimm, _GetOperandSize);
            break;
        case 2:
            ADC(vcpuins.prm, vcpuins.pimm, _GetOperandSize);
            break;
        case 3:
            SBB((void *)vcpuins.prm, (void *)vcpuins.pimm, _GetOperandSize);
            break;
        case 4:
            AND(vcpuins.prm, vcpuins.pimm, _GetOperandSize);
            break;
        case 5:
            SUB((void *)vcpuins.prm, (void *)vcpuins.pimm, _GetOperandSize);
            break;
        case 6:
            XOR((void *)vcpuins.prm, (void *)vcpuins.pimm, _GetOperandSize);
            break;
        case 7:
            CMP((void *)vcpuins.prm, (void *)vcpuins.pimm, _GetOperandSize);
            break;
        default:
            CaseError("INS_81::vcpuins.pr");
            break;
        }
    }
    else {
        ...
        switch (vcpuins.r) {
        case 0:
            ADD(vcpuins.rm, vcpuins.imm, 16);
            break;
        case 1:
            OR ((void *)vcpuins.rm, (void *)vcpuins.imm, 16);
            break;
        case 2:
            ADC(vcpuins.rm, vcpuins.imm, 16);
            break;
        case 3:
            SBB((void *)vcpuins.rm, (void *)vcpuins.imm, 16);
            break;
        case 4:
            AND(vcpuins.rm, vcpuins.imm, 16);
            break;
        case 5:
            SUB((void *)vcpuins.rm, (void *)vcpuins.imm, 16);
            break;
        case 6:
            XOR((void *)vcpuins.rm, (void *)vcpuins.imm, 16);
            break;
        case 7:
            CMP((void *)vcpuins.rm, (void *)vcpuins.imm, 16);
            break;
        default:
            CaseError("INS_81::vcpuins.r");
            break;
        }
    }
}
DONE INS_83() {
    ...
    i386(0x83) {
        ...
        switch (vcpuins.pr) {
        case 0:
            ADD(vcpuins.prm, vcpuins.pimm, len);
            break;
        case 1:
            OR ((void *)vcpuins.prm, (void *)vcpuins.pimm, len);
            break;
        case 2:
            ADC(vcpuins.prm, vcpuins.pimm, len);
            break;
        case 3:
            SBB((void *)vcpuins.prm, (void *)vcpuins.pimm, len);
            break;
        case 4:
            AND(vcpuins.prm, vcpuins.pimm, len);
            break;
        case 5:
            SUB((void *)vcpuins.prm, (void *)vcpuins.pimm, len);
            break;
        case 6:
            XOR((void *)vcpuins.prm, (void *)vcpuins.pimm, len);
            break;
        case 7:
            CMP((void *)vcpuins.prm, (void *)vcpuins.pimm, len);
            break;
        default:
            CaseError("INS_83::vcpuins.pr");
            break;
        }
    }
    else {
        ...
        switch (vcpuins.r) {
        case 0:
            ADD(vcpuins.rm, vcpuins.imm, 12);
            break;
        case 1:
            OR ((void *)vcpuins.rm, (void *)vcpuins.imm, 12);
            break;
        case 2:
            ADC(vcpuins.rm, vcpuins.imm, 12);
            break;
        case 3:
            SBB((void *)vcpuins.rm, (void *)vcpuins.imm, 12);
            break;
        case 4:
            AND(vcpuins.rm, vcpuins.imm, 12);
            break;
        case 5:
            SUB((void *)vcpuins.rm, (void *)vcpuins.imm, 12);
            break;
        case 6:
            XOR((void *)vcpuins.rm, (void *)vcpuins.imm, 12);
            break;
        case 7:
            CMP((void *)vcpuins.rm, (void *)vcpuins.imm, 12);
            break;
        default:
            CaseError("INS_83::vcpuins.r");
            break;
        }
    }
}
...
void INS_C0() {
    ...
    switch (vcpuins.r) {
    case 0:
        ROL((void *)vcpuins.rm,(void *)vcpuins.imm,8);
        break;
    case 1:
        ROR((void *)vcpuins.rm,(void *)vcpuins.imm,8);
        break;
    case 2:
        RCL((void *)vcpuins.rm,(void *)vcpuins.imm,8);
        break;
    case 3:
        RCR((void *)vcpuins.rm,(void *)vcpuins.imm,8);
        break;
    case 4:
        SHL((void *)vcpuins.rm,(void *)vcpuins.imm,8);
        break;
    case 5:
        SHR((void *)vcpuins.rm,(void *)vcpuins.imm,8);
        break;
    case 6:
        SAL((void *)vcpuins.rm,(void *)vcpuins.imm,8);
        break;
    case 7:
        SAR((void *)vcpuins.rm,(void *)vcpuins.imm,8);
        break;
    default:
        CaseError("INS_C0::vcpuins.r");
        break;
    }
}
void INS_C1() {
    ...
    switch (vcpuins.r) {
    case 0:
        ROL((void *)vcpuins.rm,(void *)vcpuins.imm,16);
        break;
    case 1:
        ROR((void *)vcpuins.rm,(void *)vcpuins.imm,16);
        break;
    case 2:
        RCL((void *)vcpuins.rm,(void *)vcpuins.imm,16);
        break;
    case 3:
        RCR((void *)vcpuins.rm,(void *)vcpuins.imm,16);
        break;
    case 4:
        SHL((void *)vcpuins.rm,(void *)vcpuins.imm,16);
        break;
    case 5:
        SHR((void *)vcpuins.rm,(void *)vcpuins.imm,16);
        break;
    case 6:
        SAL((void *)vcpuins.rm,(void *)vcpuins.imm,16);
        break;
    case 7:
        SAR((void *)vcpuins.rm,(void *)vcpuins.imm,16);
        break;
    default:
        CaseError("INS_C1::vcpuins.r");
        break;
    }
}
void RET_I16() {
...
void INS_D0() {
    ...
    switch (vcpuins.r) {
    case 0:
        ROL((void *)vcpuins.rm,NULL,8);
        break;
    case 1:
        ROR((void *)vcpuins.rm,NULL,8);
        break;
    case 2:
        RCL((void *)vcpuins.rm,NULL,8);
        break;
    case 3:
        RCR((void *)vcpuins.rm,NULL,8);
        break;
    case 4:
        SHL((void *)vcpuins.rm,NULL,8);
        break;
    case 5:
        SHR((void *)vcpuins.rm,NULL,8);
        break;
    case 6:
        SAL((void *)vcpuins.rm,NULL,8);
        break;
    case 7:
        SAR((void *)vcpuins.rm,NULL,8);
        break;
    default:
        CaseError("INS_D0::vcpuins.r");
        break;
    }
}
void INS_D1() {
    ...
    switch (vcpuins.r) {
    case 0:
        ROL((void *)vcpuins.rm,NULL,16);
        break;
    case 1:
        ROR((void *)vcpuins.rm,NULL,16);
        break;
    case 2:
        RCL((void *)vcpuins.rm,NULL,16);
        break;
    case 3:
        RCR((void *)vcpuins.rm,NULL,16);
        break;
    case 4:
        SHL((void *)vcpuins.rm,NULL,16);
        break;
    case 5:
        SHR((void *)vcpuins.rm,NULL,16);
        break;
    case 6:
        SAL((void *)vcpuins.rm,NULL,16);
        break;
    case 7:
        SAR((void *)vcpuins.rm,NULL,16);
        break;
    default:
        CaseError("INS_D1::vcpuins.r");
        break;
    }
}
void INS_D2() {
    ...
    switch (vcpuins.r) {
    case 0:
        ROL((void *)vcpuins.rm,(void *)&vcpu.cl,8);
        break;
    case 1:
        ROR((void *)vcpuins.rm,(void *)&vcpu.cl,8);
        break;
    case 2:
        RCL((void *)vcpuins.rm,(void *)&vcpu.cl,8);
        break;
    case 3:
        RCR((void *)vcpuins.rm,(void *)&vcpu.cl,8);
        break;
    case 4:
        SHL((void *)vcpuins.rm,(void *)&vcpu.cl,8);
        break;
    case 5:
        SHR((void *)vcpuins.rm,(void *)&vcpu.cl,8);
        break;
    case 6:
        SAL((void *)vcpuins.rm,(void *)&vcpu.cl,8);
        break;
    case 7:
        SAR((void *)vcpuins.rm,(void *)&vcpu.cl,8);
        break;
    default:
        CaseError("INS_D2::vcpuins.r");
        break;
    }
}
void INS_D3() {
    ...
    switch (vcpuins.r) {
    case 0:
        ROL((void *)vcpuins.rm,(void *)&vcpu.cl,16);
        break;
    case 1:
        ROR((void *)vcpuins.rm,(void *)&vcpu.cl,16);
        break;
    case 2:
        RCL((void *)vcpuins.rm,(void *)&vcpu.cl,16);
        break;
    case 3:
        RCR((void *)vcpuins.rm,(void *)&vcpu.cl,16);
        break;
    case 4:
        SHL((void *)vcpuins.rm,(void *)&vcpu.cl,16);
        break;
    case 5:
        SHR((void *)vcpuins.rm,(void *)&vcpu.cl,16);
        break;
    case 6:
        SAL((void *)vcpuins.rm,(void *)&vcpu.cl,16);
        break;
    case 7:
        SAR((void *)vcpuins.rm,(void *)&vcpu.cl,16);
        break;
    default:
        CaseError("INS_D3::vcpuins.r");
        break;
    }
}
DONE AAM() {
...
void INS_F6() {
    ...
    case 0:
        ...
        break;
    case 2:
        NOT ((void *)vcpuins.rm,8);
        break;
    case 3:
        NEG ((void *)vcpuins.rm,8);
        break;
    case 4:
        MUL ((void *)vcpuins.rm,8);
        break;
    case 5:
        IMUL((void *)vcpuins.rm,8);
        break;
    case 6:
        DIV ((void *)vcpuins.rm,8);
        break;
    case 7:
        IDIV((void *)vcpuins.rm,8);
        break;
    default:
        CaseError("INS_F6::vcpuins.r");
        break;
    }
}
void INS_F7() {
    ...
    case 0:
        ...
        break;
    case 2:
        NOT ((void *)vcpuins.rm,16);
        break;
    case 3:
        NEG ((void *)vcpuins.rm,16);
        break;
    case 4:
        MUL ((void *)vcpuins.rm,16);
        break;
    case 5:
        IMUL((void *)vcpuins.rm,16);
        break;
    case 6:
        DIV ((void *)vcpuins.rm,16);
        break;
    case 7:
        IDIV((void *)vcpuins.rm,16);
        break;
    default:
        CaseError("INS_F7::vcpuins.r");
        break;
    }
...
void INS_FE() {
    ...
    switch (vcpuins.r) {
    case 0:
        INC((void *)vcpuins.rm,8);
        break;
    case 1:
        DEC((void *)vcpuins.rm,8);
        break;
    default:
        CaseError("INS_FE::vcpuins.r");
        break;
    }
...
void INS_FF() {
    ...
    i386(0xff) {
        ...
        switch (_GetModRM_REG(modrm)) {
        case 2:
            _GetModRegRM(0, _GetOperandSize, 0x00);
            break;
        case 3:
            _GetModRegRM(0, _GetOperandSize + 16, 0x00);
            break;
        default:
            _GetModRegRM(0, _GetOperandSize, 0x01);
            break;
        ...
        switch (vcpuins.pr) {
        case 0:
            INC((void *)vcpuins.prm,16);
            break;
        case 1:
            DEC((void *)vcpuins.prm,16);
            break;
        case 2: /* CALL_RM16 */
            switch (_GetOperandSize) {
            case 16:
        ...
        case 3: /* CALL_M16_16 */
            ...
            case 32:
                ...
                break;
            default:
                CaseError("INS_FF::vcpuins.pr(3)::OperandSize");
                break;
            }
            break;
        case 4: /* JMP_RM16 */
        ...
        switch (vcpuins.r) {
        case 0:
            INC((void *)vcpuins.rm,16);
            break;
        case 1:
            DEC((void *)vcpuins.rm,16);
            break;
        case 2:	/* CALL_RM16 */
            PUSH((void *)&vcpu.eip,16);
...
static void ExecInsInit() {
    ...
    vcpu.cs.limit = vcpu.cs.base + 0xffff;
    vcpu.ss.base = vcpu.ss.selector << 4;
    vcpu.ss.limit = vcpu.ss.base + 0xffff;
    vcpu.ds.base = vcpu.ds.selector << 4;
    vcpu.ds.limit = vcpu.ds.base + 0xffff;
    vcpu.es.base = vcpu.es.selector << 4;
    vcpu.es.limit = vcpu.es.base + 0xffff;
    vcpu.fs.base = vcpu.fs.selector << 4;
    vcpu.fs.limit = vcpu.fs.base + 0xffff;
    vcpu.gs.base = vcpu.gs.selector << 4;
    vcpu.gs.limit = vcpu.gs.base + 0xffff;
}
