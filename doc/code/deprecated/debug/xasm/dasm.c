...
static void GetMem(t_nubitcc membit) {
    switch (membit) {
    case 8:
        SPRINTF(drm, "[%04X]", vramWord(diptr));
    ...
    case 16:
        ...
        break;
    default:
        SPRINTF(drm, "<ERROR:MEMBIT(%02X)>",membit);
        break;
    }
    diptr += 2;
}
static void GetImm(t_nubitcc immbit) {
    ...
    switch (immbit) {
    case 8:
        SPRINTF(dimm, "%02X", vramByte(diptr));
        diptr += 1;
        SPRINTF(dimmoff8,  "L%08X", (t_nubit32)(diptr+imm8));
        SPRINTF(dimmsign,  "%c%02X", sign8, immu8);
        break;
    case 16:
        SPRINTF(dimm, "%04X", vramWord(diptr));
        diptr += 2;
        SPRINTF(dimmoff16, "L%08X", (t_nubit32)(diptr+imm16));
        break;
    case 32:
        SPRINTF(dimm, "%08X", vramDWord(diptr));
        diptr += 4;
        break;
    default:
        SPRINTF(dimm, "<ERROR:IMMBIT(%02X)>",immbit);
        break;
    }
}
static void GetModRegRM(t_nubit8 regbit,t_nubit8 rmbit) {
    ...
    case 0:
        ...
        case 7:
            ...
            break;
        default:
            SPRINTF(drm, "<ERROR:ModRM_MOD(%02X),ModRM_RM(%02X)>", _GetModRM_MOD(modrm), _GetModRM_RM(modrm));
            break;
        }
        break;
    case 1:
        disp8 = (t_nsbit8)vramByte(diptr);
        diptr += 1;
        sign = (disp8 & 0x80) ? '-' : '+';
        disp8u = (disp8 & 0x80) ? ((~disp8) + 0x01) : disp8;
        switch (_GetModRM_RM(modrm)) {
        case 0:
            SPRINTF(drm, "[BX+SI%c%02X]", sign, disp8u);
            ...
            break;
        case 1:
            SPRINTF(drm, "[BX+DI%c%02X]", sign, disp8u);
            ...
            break;
        case 2:
            SPRINTF(drm, "[BP+SI%c%02X]", sign, disp8u);
            ...
            break;
        case 3:
            SPRINTF(drm, "[BP+DI%c%02X]", sign, disp8u);
            ...
            break;
        case 4:
            SPRINTF(drm, "[SI%c%02X]", sign, disp8u);
            ...
            break;
        case 5:
            SPRINTF(drm, "[DI%c%02X]", sign, disp8u);
            ...
            break;
        case 6:
            SPRINTF(drm, "[BP%c%02X]", sign, disp8u);
            ...
            break;
        case 7:
            SPRINTF(drm, "[BX%c%02X]", sign, disp8u);
    ...
    case 3:
        ...
        switch (_GetModRM_RM(modrm)) {
        case 0:
            if (rmbit == 8) SPRINTF(drm, "AL");
            else SPRINTF(drm, "AX");
            break;
        case 1:
            if (rmbit == 8) SPRINTF(drm, "CL");
            else SPRINTF(drm, "CX");
            break;
        case 2:
            if (rmbit == 8) SPRINTF(drm, "DL");
            else SPRINTF(drm, "DX");
            break;
        case 3:
            if (rmbit == 8) SPRINTF(drm, "BL");
            else SPRINTF(drm, "BX");
            break;
        case 4:
            if (rmbit == 8) SPRINTF(drm, "AH");
            else SPRINTF(drm, "SP");
            break;
        case 5:
            if (rmbit == 8) SPRINTF(drm, "CH");
            else SPRINTF(drm, "BP");
            break;
        case 6:
            if (rmbit == 8) SPRINTF(drm, "DH");
            else SPRINTF(drm, "SI");
            break;
        case 7:
            if (rmbit == 8) SPRINTF(drm, "BH");
            else SPRINTF(drm, "DI");
            break;
        default:
            SPRINTF(drm, "<ERROR:ModRM_MOD(%02X),ModRM_RM(%02X)>", _GetModRM_MOD(modrm), _GetModRM_RM(modrm));
        ...
        break;
    default:
        SPRINTF(drm, "<ERROR:ModRM_MOD(modrm)(%02X)>", _GetModRM_MOD(modrm));
        break;
    }
    switch (regbit) {
    case 0:
        rid = _GetModRM_REG(modrm);
        break;
    case 4:
        ...
        case 3:
            ...
            break;
        default:
            SPRINTF(dr, "<ERROR:REGBIT(%02X),ModRM_REG(%02X)>", regbit, _GetModRM_REG(modrm));
            break;
        }
        break;
    case 8:
    ...
    case 16:
        ...
        break;
    default:
        SPRINTF(dr, "<ERROR:REGBIT(%02X)>", regbit);
        break;
    }
}
...
static void INS_0F() {
    ...
    switch (opcode) {
    case 0x00:
        SPRINTF(dop, "INS_0F_00");
        break;
    case 0x01:
        SPRINTF(dop, "INS_0F_01");
        break;
    case 0x02:
        SPRINTF(dop, "LAR_R32_RM32");
        break;
    case 0x03:
        SPRINTF(dop, "LSL_R32_RM32");
        break;
    case 0x04:
        UndefinedOpcode();
        break;
    ...
    case 0x1f:
        ...
        break;
    case 0x20:
        SPRINTF(dop, "MOV_R32_CR");
        break;
    case 0x21:
        SPRINTF(dop, "MOV_R32_DR");
        break;
    case 0x22:
        SPRINTF(dop, "MOV_CR_R32");
        break;
    case 0x23:
        SPRINTF(dop, "MOV_DR_R32");
        break;
    case 0x24:
        SPRINTF(dop, "MOV_R32_TR");
        break;
    case 0x25:
        UndefinedOpcode();
        break;
    case 0x26:
        SPRINTF(dop, "MOV_TR_R32");
        break;
    case 0x27:
        UndefinedOpcode();
        break;
    ...
    case 0x7f:
        ...
        break;
    case 0x80:
        SPRINTF(dop, "JO_REL32");
        break;
    case 0x81:
        SPRINTF(dop, "JNO_REL32");
        break;
    case 0x82:
        SPRINTF(dop, "JC_REL32");
        break;
    case 0x83:
        SPRINTF(dop, "JNC_REL32");
        break;
    case 0x84:
        SPRINTF(dop, "JZ_REL32");
        break;
    case 0x85:
        SPRINTF(dop, "JNZ_REL32");
        break;
    case 0x86:
        SPRINTF(dop, "JNA_REL32");
        break;
    case 0x87:
        SPRINTF(dop, "JA_REL32");
        break;
    case 0x88:
        SPRINTF(dop, "JS_REL32");
        break;
    case 0x89:
        SPRINTF(dop, "JNS_REL32");
        break;
    case 0x8a:
        SPRINTF(dop, "JP_REL32");
        break;
    case 0x8b:
        SPRINTF(dop, "JNP_REL32");
        break;
    case 0x8c:
        SPRINTF(dop, "JL_REL32");
        break;
    case 0x8d:
        SPRINTF(dop, "JNL_REL32");
        break;
    case 0x8e:
        SPRINTF(dop, "JNG_REL32");
        break;
    case 0x8f:
        SPRINTF(dop, "JG_REL32");
        break;
    case 0x90:
        SPRINTF(dop, "SETO_REL32");
        break;
    case 0x91:
        SPRINTF(dop, "SETNO_REL32");
        break;
    case 0x92:
        SPRINTF(dop, "SETC_REL32");
        break;
    case 0x93:
        SPRINTF(dop, "SETNC_REL32");
        break;
    case 0x94:
        SPRINTF(dop, "SETZ_REL32");
        break;
    case 0x95:
        SPRINTF(dop, "SETNZ_REL32");
        break;
    case 0x96:
        SPRINTF(dop, "SETNA_REL32");
        break;
    case 0x97:
        SPRINTF(dop, "SETA_REL32");
        break;
    case 0x98:
        SPRINTF(dop, "SETS_REL32");
        break;
    case 0x99:
        SPRINTF(dop, "SETNS_REL32");
        break;
    case 0x9a:
        SPRINTF(dop, "SETP_REL32");
        break;
    case 0x9b:
        SPRINTF(dop, "SETNP_REL32");
        break;
    case 0x9c:
        SPRINTF(dop, "SETL_REL32");
        break;
    case 0x9d:
        SPRINTF(dop, "SETNL_REL32");
        break;
    case 0x9e:
        SPRINTF(dop, "SETNG_REL32");
        break;
    case 0x9f:
        SPRINTF(dop, "SETG_REL32");
        break;
    case 0xa0:
        SPRINTF(dop, "PUSH_FS");
        break;
    ...
    case 0xa2:
        ...
        break;
    case 0xa3:
        SPRINTF(dop, "BT_RM32_R32");
        break;
    case 0xa4:
        SPRINTF(dop, "SHLD_RM32_R32_I8");
        break;
    case 0xa5:
        SPRINTF(dop, "SHLD_RM32_R32_CL");
        break;
    case 0xa6:
        SPRINTF(dop, "UndefinedOpcode");
        break;
    case 0xa7:
        SPRINTF(dop, "UndefinedOpcode");
        break;
    ...
    case 0xaa:
        ...
        break;
    case 0xab:
        SPRINTF(dop, "BTS_RM32_R32");
        break;
    case 0xac:
        SPRINTF(dop, "SHRD_RM32_R32_I8");
        break;
    case 0xad:
        SPRINTF(dop, "SHRD_RM32_R32_CL");
        break;
    case 0xae:
        SPRINTF(dop, "UndefinedOpcode");
        break;
    case 0xaf:
        SPRINTF(dop, "IMUL_R32_RM32");
        break;
    case 0xb0:
        SPRINTF(dop, "UndefinedOpcode");
        break;
    case 0xb1:
        ...
        break;
    case 0xb2:
        SPRINTF(dop, "LSS_R32_M16_32");
        break;
    case 0xb3:
        SPRINTF(dop, "BTR_RM32_R32");
        break;
    case 0xb4:
        SPRINTF(dop, "LFS_R32_M16_32");
        break;
    case 0xb5:
        SPRINTF(dop, "LGS_R32_M16_32");
        break;
    case 0xb6:
        SPRINTF(dop, "MOVZX_R32_RM8");
        break;
    case 0xb7:
        SPRINTF(dop, "MOVZX_R32_RM16");
        break;
    case 0xb8:
        SPRINTF(dop, "UndefinedOpcode");
        break;
    case 0xb9:
        ...
        break;
    case 0xba:
        SPRINTF(dop, "INS_0F_BA");
        break;
    case 0xbb:
        SPRINTF(dop, "BTC_RM32_R32");
        break;
    case 0xbc:
        SPRINTF(dop, "BSF_R32_RM32");
        break;
    case 0xbd:
        SPRINTF(dop, "BSR_R32_RM32");
        break;
    case 0xbe:
        SPRINTF(dop, "MOVSX_R32_RM8");
        break;
    case 0xbf:
        SPRINTF(dop, "MOVSX_R32_RM16");
        break;
    case 0xc0:
        UndefinedOpcode();
        break;
...
static void INS_80() {
    ...
    case 7:
        ...
        break;
    default:
        SPRINTF(dop, "<ERROR:REGID(%02X)>", rid);
        return;
    }
...
static void INS_FF() {
    ...
    case 3:
        ...
        break;
    case 4:
        SPRINTF(dop, "JMP"); /* JMP_RM16 */
        SPRINTF(dopr, "%s", drm);
        break;
    case 5:
        SPRINTF(dop, "JMP"); /* JMP_M16_16 */
        SPRINTF(dopr, "FAR %s", drm);
        break;
    case 6:
        SPRINTF(dop, "PUSH"); /* PUSH_RM16 */
        SPRINTF(dopr, "%s", drm);
        break;
    default:
        SPRINTF(dop, "<ERROR:REGID(%02X)>", rid);
...
static void exec(t_nubit8 opcode) {
    ...
    case 0xd9:
        UndefinedOpcode();
        break; //case 0xd9: INS_D9();     break;
    case 0xda:
        UndefinedOpcode();
        break;
    case 0xdb:
        UndefinedOpcode();
        break; //case 0xdb: INS_UndefinedOpcode();     break;
    case 0xdc:
        UndefinedOpcode();
        break;
    case 0xdd:
