...
static t_aasm_token gettoken(t_string str) {
    ...
    do {
        ...
        case STATE_NUM1:
            switch (tokch) {
            case '0':
                tokimm8 = (tokimm8 << 4) | 0x00;
                state = STATE_NUM2;
                break;
            case '1':
                tokimm8 = (tokimm8 << 4) | 0x01;
                state = STATE_NUM2;
                break;
            case '2':
                tokimm8 = (tokimm8 << 4) | 0x02;
                state = STATE_NUM2;
                break;
            case '3':
                tokimm8 = (tokimm8 << 4) | 0x03;
                state = STATE_NUM2;
                break;
            case '4':
                tokimm8 = (tokimm8 << 4) | 0x04;
                state = STATE_NUM2;
                break;
            case '5':
                tokimm8 = (tokimm8 << 4) | 0x05;
                state = STATE_NUM2;
                break;
            case '6':
                tokimm8 = (tokimm8 << 4) | 0x06;
                state = STATE_NUM2;
                break;
            case '7':
                tokimm8 = (tokimm8 << 4) | 0x07;
                state = STATE_NUM2;
                break;
            case '8':
                tokimm8 = (tokimm8 << 4) | 0x08;
                state = STATE_NUM2;
                break;
            case '9':
                tokimm8 = (tokimm8 << 4) | 0x09;
                state = STATE_NUM2;
                break;
            case 'a':
                tokimm8 = (tokimm8 << 4) | 0x0a;
                state = STATE_NUM2;
                break;
            case 'b':
                tokimm8 = (tokimm8 << 4) | 0x0b;
                state = STATE_NUM2;
                break;
            case 'c':
                tokimm8 = (tokimm8 << 4) | 0x0c;
                state = STATE_NUM2;
                break;
            case 'd':
                tokimm8 = (tokimm8 << 4) | 0x0d;
                state = STATE_NUM2;
                break;
            case 'e':
                tokimm8 = (tokimm8 << 4) | 0x0e;
                state = STATE_NUM2;
                break;
            case 'f':
                tokimm8 = (tokimm8 << 4) | 0x0f;
                state = STATE_NUM2;
                break;
            default:
                tokptr--;
        ...
        case STATE_NUM2:
            ...
            switch (tokch) {
            case '0':
                tokimm16 = (tokimm16 << 4) | 0x0000;
                state = STATE_NUM3;
                break;
            case '1':
                tokimm16 = (tokimm16 << 4) | 0x0001;
                state = STATE_NUM3;
                break;
            case '2':
                tokimm16 = (tokimm16 << 4) | 0x0002;
                state = STATE_NUM3;
                break;
            case '3':
                tokimm16 = (tokimm16 << 4) | 0x0003;
                state = STATE_NUM3;
                break;
            case '4':
                tokimm16 = (tokimm16 << 4) | 0x0004;
                state = STATE_NUM3;
                break;
            case '5':
                tokimm16 = (tokimm16 << 4) | 0x0005;
                state = STATE_NUM3;
                break;
            case '6':
                tokimm16 = (tokimm16 << 4) | 0x0006;
                state = STATE_NUM3;
                break;
            case '7':
                tokimm16 = (tokimm16 << 4) | 0x0007;
                state = STATE_NUM3;
                break;
            case '8':
                tokimm16 = (tokimm16 << 4) | 0x0008;
                state = STATE_NUM3;
                break;
            case '9':
                tokimm16 = (tokimm16 << 4) | 0x0009;
                state = STATE_NUM3;
                break;
            case 'a':
                tokimm16 = (tokimm16 << 4) | 0x000a;
                state = STATE_NUM3;
                break;
            case 'b':
                tokimm16 = (tokimm16 << 4) | 0x000b;
                state = STATE_NUM3;
                break;
            case 'c':
                tokimm16 = (tokimm16 << 4) | 0x000c;
                state = STATE_NUM3;
                break;
            case 'd':
                tokimm16 = (tokimm16 << 4) | 0x000d;
                state = STATE_NUM3;
                break;
            case 'e':
                tokimm16 = (tokimm16 << 4) | 0x000e;
                state = STATE_NUM3;
                break;
            case 'f':
                tokimm16 = (tokimm16 << 4) | 0x000f;
                state = STATE_NUM3;
                break;
            default:
                tokptr--;
...
static void printtoken(t_aasm_token token) {
    ...
    case TOKEN_SHORT:
        ...
        break;
    case TOKEN_IMM8:
        vapiPrint(" I8(%02X) ", tokimm8);
        break;
    case TOKEN_IMM16:
        vapiPrint(" I16(%04X) ", tokimm16);
        break;
    case TOKEN_AH:
        vapiPrint(" AH ");
        break;
