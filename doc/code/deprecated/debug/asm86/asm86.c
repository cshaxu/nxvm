...
static int dModRM(char *dasmStmt,Operand *resOperand,t_nubit8 *loc,const char *op,InsType it) {
    ...
    switch (it) {
    case RM8_R8:
        dRM(8)        dCOMMA    dR(8)        break;
    case R8_RM8:
        dR(8)        dCOMMA    dRM(8)        break;
    case RM16_R16:
        dRM(16)        dCOMMA    dR(16)        break;
    case R16_RM16:
        dR(16)        dCOMMA    dRM(16)        break;
    case RM8_I8:
        dRM(8)        dCOMMA    dImm(8)        break;
    case I8_RM8:
        dImm(8)        dCOMMA    dRM(8)        break;
    case RM16_I16:
        dRM(16)        dCOMMA    dImm(16)    break;
    case I16_RM16:
        dImm(16)    dCOMMA    dRM(16)        break;
    case RM16_S16:
        dRM(16)        dCOMMA    dS            break;
    case S16_RM16:
        dS            dCOMMA    dRM(16)        break;
    case R16_MX:
        dR(16)        dCOMMA    dRM(0)        break;
    case RM16_NONE:
        dRM(0)                            break;
    default:
        dANY("(ERROR:INSFORMAT)")                break;
    }
    return len;
}
static int dRImm(char *dasmStmt,Operand *resOperand,t_nubit8 *loc,const char *op,InsType it) {
    ...
    switch (it) {
        \
    case AL_I8:
        dANY("AL")    dCOMMA    dImm(8)        break;
    case I8_AL:
        dImm(8)        dCOMMA    dANY("AL")    break;
    case AX_I16:
        dANY("AX")    dCOMMA    dImm(16)    break;
    case I16_AX:
        dImm(16)    dCOMMA    dANY("AX")    break;
    case AX_I8:
        dANY("AX")    dCOMMA    dImm(8)        break;
    case I8_AX:
        dImm(8)        dCOMMA    dANY("AX")    break;
    default:
        dANY("(ERROR:REGIMM)")            break;
    }
    return len;
}
...
static int dMovOff(char *dasmStmt,Operand *resOperand,t_nubit8 *loc,InsType it) {
    ...
    switch (it) {
        \
    case AL_I8:
        dANY("AL")    dCOMMA    dOff(8)        break;
    case I8_AL:
        dOff(8)        dCOMMA    dANY("AL")    break;
    case AX_I16:
        dANY("AX")    dCOMMA    dOff(16)    break;
    case I16_AX:
        dOff(16)    dCOMMA    dANY("AX")    break;
    default:
        dANY("(ERROR:REGIMM)");
        break;
    }
...
static int dMovImm(char *dasmStmt,Operand *resOperand,t_nubit8 *loc,t_nubit8 op) {
    ...
    switch (myop) {
    case 0xb0:
        dR(8)    dCOMMA    dImm(8)        break;
    case 0xb8:
        dR(16)    dCOMMA    dImm(16)    break;
    default:
        dANY("(ERROR:MOVOP)");
        break;
    }
...
static int dGroup2(char *dasmStmt,Operand *resOperand,t_nubit8 *loc,t_nubit8 op) {
    ...
    case 7:
        dANY("SAR")    break;
    default:
        dANY("(ERROR:OPD0H)")break;
    }
    dANY("\t")
    switch (op) {
    case 0xd0:
        dRM(8)    if (modrm.reg < 4) dANY(",1")    break;
    case 0xd1:
        dRM(16)    if (modrm.reg < 4) dANY(",1")    break;
    case 0xd2:
        dRM(8)    dANY(",CL")    break;
    case 0xd3:
        dRM(16)    dANY(",CL")    break;
    }
    return len;
}
static int dAAX(char *dasmStmt,Operand *resOperand,t_nubit8 *loc,const char *op) {
    ...
    dANY(op)
    if (imm != 0x0a) {
        dANY("\t")    dStrCat8u(dasmStmt,(t_nubit8)imm);
    }
    return len;
}
...
static int dGroup3(char *dasmStmt,Operand *resOperand,t_nubit8 *loc,t_nubit8 op) {
    ...
    case 7:
        dANY("IDIV\t")    break;
    default:
        dANY("(ERROR:GROUP3)\t")    break;
    }
    switch (op) {
    case 0xf6:
        dRM(8)    if (modrm.reg == 0) {
            dCOMMA    dImm(8)
        }
        break;
    case 0xf7:
        dRM(16)    if (modrm.reg == 0) {
            dCOMMA    dImm(16)
        }
        break;
    default:
...
int disassemble(char *dasmStmt,Operand *resOperand,
    ...
    switch (opcode) {
    case 0x00:
        dEmitRM(dSOL,"ADD",RM8_R8);
        break;
    case 0x01:
        dEmitRM(dSOL,"ADD",RM16_R16);
        break;
    case 0x02:
        dEmitRM(dSOL,"ADD",R8_RM8);
        break;
    case 0x03:
        dEmitRM(dSOL,"ADD",R16_RM16);
        break;
    case 0x04:
        dEmitRI(dSOL,"ADD",AL_I8);
        break;
    case 0x05:
        dEmitRI(dSOL,"ADD",AX_I16);
        break;
    case 0x06:
        dEmitOP(dSOL,"PUSH\tES");
        break;
    case 0x07:
        dEmitOP(dSOL,"POP\tES");
        break;
    case 0x08:
        dEmitRM(dSOL,"OR",RM8_R8);
        break;
    case 0x09:
        dEmitRM(dSOL,"OR",RM16_R16);
        break;
    case 0x0a:
        dEmitRM(dSOL,"OR",R8_RM8);
        break;
    case 0x0b:
        dEmitRM(dSOL,"OR",R16_RM16);
        break;
    case 0x0c:
        dEmitRI(dSOL,"OR",AL_I8);
        break;
    case 0x0d:
        dEmitRI(dSOL,"OR",AX_I16);
        break;
    case 0x0e:
        dEmitOP(dSOL,"PUSH\tCS");
        break;
    case 0x0f:
        dEmitOP(dSOL,"POP\tCS");
        break; /* IS NO LONGER 'POP CS' AFTER 8086 */
    case 0x10:
        dEmitRM(dSOL,"ADC",RM8_R8);
        break;
    case 0x11:
        dEmitRM(dSOL,"ADC",RM16_R16);
        break;
    case 0x12:
        dEmitRM(dSOL,"ADC",R8_RM8);
        break;
    case 0x13:
        dEmitRM(dSOL,"ADC",R16_RM16);
        break;
    case 0x14:
        dEmitRI(dSOL,"ADC",AL_I8);
        break;
    case 0x15:
        dEmitRI(dSOL,"ADC",AX_I16);
        break;
    case 0x16:
        dEmitOP(dSOL,"PUSH\tSS");
        break;
    case 0x17:
        dEmitOP(dSOL,"POP\tSS");
        break;
    case 0x18:
        dEmitRM(dSOL,"SBB",RM8_R8);
        break;
    case 0x19:
        dEmitRM(dSOL,"SBB",RM16_R16);
        break;
    case 0x1a:
        dEmitRM(dSOL,"SBB",R8_RM8);
        break;
    case 0x1b:
        dEmitRM(dSOL,"SBB",R16_RM16);
        break;
    case 0x1c:
        dEmitRI(dSOL,"SBB",AL_I8);
        break;
    case 0x1d:
        dEmitRI(dSOL,"SBB",AX_I16);
        break;
    case 0x1e:
        dEmitOP(dSOL,"PUSH\tDS");
        break;
    case 0x1f:
        dEmitOP(dSOL,"POP\tDS");
        break;
    case 0x20:
        dEmitRM(dSOL,"AND",RM8_R8);
        break;
    case 0x21:
        dEmitRM(dSOL,"AND",RM16_R16);
        break;
    case 0x22:
        dEmitRM(dSOL,"AND",R8_RM8);
        break;
    case 0x23:
        dEmitRM(dSOL,"AND",R16_RM16);
        break;
    case 0x24:
        dEmitRI(dSOL,"AND",AL_I8);
        break;
    case 0x25:
        dEmitRI(dSOL,"AND",AX_I16);
        break;
    case 0x26:
        dEmitSL(dSOL,0);
        break;
    case 0x27:
        ...
        break;
    case 0x28:
        dEmitRM(dSOL,"SUB",RM8_R8);
        break;
    case 0x29:
        dEmitRM(dSOL,"SUB",RM16_R16);
        break;
    case 0x2a:
        dEmitRM(dSOL,"SUB",R8_RM8);
        break;
    case 0x2b:
        dEmitRM(dSOL,"SUB",R16_RM16);
        break;
    case 0x2c:
        dEmitRI(dSOL,"SUB",AL_I8);
        break;
    case 0x2d:
        dEmitRI(dSOL,"SUB",AX_I16);
        break;
    case 0x2e:
        dEmitSL(dSOL,1);
        break;
    case 0x2f:
        ...
        break;
    case 0x30:
        dEmitRM(dSOL,"XOR",RM8_R8);
        break;
    case 0x31:
        dEmitRM(dSOL,"XOR",RM16_R16);
        break;
    case 0x32:
        dEmitRM(dSOL,"XOR",R8_RM8);
        break;
    case 0x33:
        dEmitRM(dSOL,"XOR",R16_RM16);
        break;
    case 0x34:
        dEmitRI(dSOL,"XOR",AL_I8);
        break;
    case 0x35:
        dEmitRI(dSOL,"XOR",AX_I16);
        break;
    case 0x36:
        dEmitSL(dSOL,2);
        break;
    case 0x37:
        ...
        break;
    case 0x38:
        dEmitRM(dSOL,"CMP",RM8_R8);
        break;
    case 0x39:
        dEmitRM(dSOL,"CMP",RM16_R16);
        break;
    case 0x3a:
        dEmitRM(dSOL,"CMP",R8_RM8);
        break;
    case 0x3b:
        dEmitRM(dSOL,"CMP",R16_RM16);
        break;
    case 0x3c:
        dEmitRI(dSOL,"CMP",AL_I8);
        break;
    case 0x3d:
        dEmitRI(dSOL,"CMP",AX_I16);
        break;
    case 0x3e:
        dEmitSL(dSOL,3);
        break;
    ...
    case 0x4f:
        ...
        break;
    case 0x50:
        dEmitOP(dSOL,"PUSH\tAX");
        break;
    case 0x51:
        dEmitOP(dSOL,"PUSH\tCX");
        break;
    case 0x52:
        dEmitOP(dSOL,"PUSH\tDX");
        break;
    case 0x53:
        dEmitOP(dSOL,"PUSH\tBX");
        break;
    case 0x54:
        dEmitOP(dSOL,"PUSH\tSP");
        break;
    case 0x55:
        dEmitOP(dSOL,"PUSH\tBP");
        break;
    case 0x56:
        dEmitOP(dSOL,"PUSH\tSI");
        break;
    case 0x57:
        dEmitOP(dSOL,"PUSH\tDI");
        break;
    case 0x58:
        dEmitOP(dSOL,"POP\tAX");
        break;
    ...
    case 0x6f:
        ...
        break;
    case 0x70:
        dEmitJR(dSOL,"JO",locOffset,8);
        break;
    case 0x71:
        dEmitJR(dSOL,"JNO",locOffset,8);
        break;
    case 0x72:
        dEmitJR(dSOL,"JC",locOffset,8);
        break;
    case 0x73:
        dEmitJR(dSOL,"JNC",locOffset,8);
        break;
    case 0x74:
        dEmitJR(dSOL,"JZ",locOffset,8);
        break;
    case 0x75:
        dEmitJR(dSOL,"JNZ",locOffset,8);
        break;
    case 0x76:
        dEmitJR(dSOL,"JBE",locOffset,8);
        break;
    case 0x77:
        dEmitJR(dSOL,"JA",locOffset,8);
        break;
    case 0x78:
        dEmitJR(dSOL,"JS",locOffset,8);
        break;
    case 0x79:
        dEmitJR(dSOL,"JNS",locOffset,8);
        break;
    case 0x7a:
        dEmitJR(dSOL,"JP",locOffset,8);
        break;
    case 0x7b:
        dEmitJR(dSOL,"JNP",locOffset,8);
        break;
    case 0x7c:
        dEmitJR(dSOL,"JL",locOffset,8);
        break;
    case 0x7d:
        dEmitJR(dSOL,"JNL",locOffset,8);
        break;
    case 0x7e:
        dEmitJR(dSOL,"JLE",locOffset,8);
        break;
    case 0x7f:
        dEmitJR(dSOL,"JG",locOffset,8);
        break;
    case 0x80:
        dEmitG1;
        break;
    ...
    case 0x83:
        ...
        break;
    case 0x84:
        dEmitRM(dSOL,"TEST",RM8_R8);
        break;
    case 0x85:
        dEmitRM(dSOL,"TEST",RM16_R16);
        break;
    case 0x86:
        dEmitRM(dSOL,"XCHG",R8_RM8);
        break;
    case 0x87:
        dEmitRM(dSOL,"XCHG",R16_RM16);
        break;
    case 0x88:
        dEmitRM(dSOL,"MOV",RM8_R8);
        break;
    case 0x89:
        dEmitRM(dSOL,"MOV",RM16_R16);
        break;
    case 0x8a:
        dEmitRM(dSOL,"MOV",R8_RM8);
        break;
    case 0x8b:
        dEmitRM(dSOL,"MOV",R16_RM16);
        break;
    case 0x8c:
        dEmitRM(dSOL,"MOV",RM16_S16);
        break;
    case 0x8d:
        dEmitRM(dSOL,"LEA",R16_MX);
        break;
    case 0x8e:
        dEmitRM(dSOL,"MOV",S16_RM16);
        break;
    case 0x8f:
        dEmitRM(dSOL,"POP",RM16_NONE);
        break;
    case 0x90:
        dEmitOP(dSOL,"NOP");
        break;
    ...
    case 0xa7:
        ...
        break;
    case 0xa8:
        dEmitRI(dSOL,"TEST",AL_I8);
        break;
    case 0xa9:
        dEmitRI(dSOL,"TEST",AX_I16);
        break;
    case 0xaa:
        dEmitOP(dSOL,"STOSB");
        break;
    ...
    case 0xc3:
        ...
        break;
    case 0xc4:
        dEmitRM(dSOL,"LES",R16_MX);
        break;
    case 0xc5:
        dEmitRM(dSOL,"LDS",R16_MX);
        break;
    case 0xc6:
        dEmitRM(dSOL,"MOV",RM8_I8);
        break;
    case 0xc7:
        dEmitRM(dSOL,"MOV",RM16_I16);
        break;
    case 0xc8:
        dEmitDB;
        break;
    ...
    case 0xdf:
        ...
        break;
    case 0xe0:
        dEmitJR(dSOL,"LOOPNZ",locOffset,8);
        break;
    case 0xe1:
        dEmitJR(dSOL,"LOOPZ",locOffset,8);
        break;
    case 0xe2:
        dEmitJR(dSOL,"LOOP",locOffset,8);
        break;
    case 0xe3:
        dEmitJR(dSOL,"JCXZ",locOffset,8);
        break;
    case 0xe4:
        dEmitRI(dSOL,"IN",AL_I8);
        break;
    case 0xe5:
        dEmitRI(dSOL,"IN",AX_I8);
        break;
    case 0xe6:
        dEmitRI(dSOL,"OUT",I8_AL);
        break;
    case 0xe7:
        dEmitRI(dSOL,"OUT",I8_AX);
        break;
    case 0xe8:
        dEmitJR(dSOL,"CALL",locOffset,16);
        break;
    case 0xe9:
        dEmitJR(dSOL,"JMP",locOffset,16);
        break;
    case 0xea:
        dEmitJF(dSOL,"JMP");
        break;
    case 0xeb:
        dEmitJR(dSOL,"JMP",locOffset,8);
        break;
    case 0xec:
        dEmitOP(dSOL,"IN\tAL,DX");
        break;
    case 0xed:
        dEmitOP(dSOL,"IN\tAX,DX");
        break;
    case 0xee:
        dEmitOP(dSOL,"OUT\tDX,AL");
        break;
    case 0xef:
        dEmitOP(dSOL,"OUT\tDX,AX");
        break;
    case 0xf0:
        dEmitPR(dSOL,"LOCK");
        break;
