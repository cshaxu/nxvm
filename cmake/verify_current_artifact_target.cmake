...
if(NOT current_targets STREQUAL "add_current_vm_artifact(vm-0-5-0207")
    message(FATAL_ERROR "Unexpected current artifact target: ${current_targets}")
endif()

string(FIND "${presets_source}" "\"targets\": [\"vm-0-5-0207\"]"
    preset_position)
if(preset_position EQUAL -1)
    message(FATAL_ERROR "The current GCC preset does not name vm-0-5-0207")
endif()
