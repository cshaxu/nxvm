...
file(READ "${PROJECT_SOURCE_DIR}/src/vm/composition/session/selected_session.c"
    selected_source)
...
string(FIND "${adapter_source}" "vm_session_borrow_selected(context)"
    adapter_helper_position)
if(NOT selected_borrow_call_count EQUAL 1 OR adapter_helper_position EQUAL -1)
    message(FATAL_ERROR "Selected-session borrowing is not converged in composition")
endif()

foreach(obsolete_helper "vm_session_provider_selected" "vm_session_machine_selected")
...
message("M5:T203:S1:CONSOLE-ADAPTER-CLOSURE:OK")
