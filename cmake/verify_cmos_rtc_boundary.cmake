...
foreach(required IN ITEMS "vm_machine_cmos_advance"
    "core_machine_pic_irq_source_assert" "core_machine_pic_irq_source_deassert"
    "VCMOS_REG_C_IRQF" "VCMOS_REG_C_UF" "VCMOS_REG_C_PF")
    string(FIND "${cmos_source}" "${required}" position)
    if(position EQUAL -1)
...
string(FIND "${lifecycle_source}" "vm_session_machine_devices_advance"
    lifecycle_position)
string(FIND "${devices_source}" "vm_machine_cmos_advance" device_position)
