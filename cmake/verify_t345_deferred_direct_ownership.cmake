...
if(NOT project_t345_owner_test_count EQUAL 180 OR
...
if(NOT project_t345_s2_target_count EQUAL 177)
    message(FATAL_ERROR "T345 S2 target inventory has ${project_t345_s2_target_count} entries; expected 177.")
endif()
...
if(NOT project_t345_safe_production_count EQUAL 2 OR
        ...
        NOT project_t345_mixed_count EQUAL 50)
    message(FATAL_ERROR
...
if(NOT project_t345_expected_residual_count EQUAL 57 OR
        NOT project_t345_s4_residual_count EQUAL 57)
    message(FATAL_ERROR
