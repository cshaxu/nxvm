...
if(NOT project_t345_owner_test_count EQUAL 143 OR
...
if(NOT project_t345_s2_target_count EQUAL 140)
    message(FATAL_ERROR "T345 S2 target inventory has ${project_t345_s2_target_count} entries; expected 140.")
endif()
...
if(NOT project_t345_safe_production_count EQUAL 2 OR
        ...
        NOT project_t345_mixed_count EQUAL 49)
    message(FATAL_ERROR
...
if(NOT project_t345_expected_residual_count EQUAL 56 OR
        NOT project_t345_s4_residual_count EQUAL 56)
    message(FATAL_ERROR
