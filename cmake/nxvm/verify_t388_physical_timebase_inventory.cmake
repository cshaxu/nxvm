...
set(machine_model "${PROJECT_SOURCE_DIR}/src/app-nxvm/devices/cpu_timing_model.c")
set(machine_scheduler "${PROJECT_SOURCE_DIR}/src/app-nxvm/devices/machine_scheduler.c")
set(timing "${PROJECT_SOURCE_DIR}/src/app-nxvm/devices/cpu_timing.c")
set(session "${PROJECT_SOURCE_DIR}/src/app-nxvm/machine/waiting.c")
set(evidence "${PROJECT_SOURCE_DIR}/docs/nxvm/etc/evidence/t388-s1-physical-timebase-inventory.md")
