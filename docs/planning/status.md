...
The owner may select either a bounded remaining M5 code cleanup task or M6 T1
owned-DOS design. M7 implementation remains ineligible until M6 defines and
