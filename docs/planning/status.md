...
**Idle. M5 T266 is closed.** The next implementation needs its own approved
packet. T267 remains the next pending M5 queue entry; it must select one
corpus-backed AUX protocol increment rather than claim broad mouse support.
