...
full GCC/CTest matrix passed 77/77 with no CPU behavior repair required.  This
is an evidence-backed baseline, not a claim that every 8086 opcode family has
been exhaustively verified.  See [the T240 record](m5-t240-real-mode-cpu-trust.md).
