...
| T246 | T243, T245 | Two-phase validated entry plan: topology/image registration only in `INITIALIZED`, then real-mode state plus ordinary-RAM preload copies atomically applied at a clean `STOPPED` reset boundary. |
