...
| T238 | T219, T236 | **S1 complete.** The only admitted future surface is direct-port `EGA-320x200x16-direct`: VADP-owned non-mirrored planar VRAM/latches, frozen core memory routing, and a copied 16-entry fixed RGBI frame. S2/S3 alone may implement and verify it; DAC, BIOS modes, and all other EGA/VGA families remain excluded. |
