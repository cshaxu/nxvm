...
| T240 | T216--T239 | Build the ROM/DOS/device real-mode **8086** trust corpus. Classify existing 80186+ forms only as profile-dependent boundaries; fix only reproducible 8086 instruction, prefix, fault, or I/O defects required by that corpus; do not start protected mode. |
