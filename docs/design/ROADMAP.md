...
[closure checklist](../etc/governance/m5-closure-checklist.md) has current evidence for every
applicable item.
...
**Entry gate:** M5 proves the core second-consumer boundary with no public raw
core-object borrow. M6 does not repair or redefine that boundary.
