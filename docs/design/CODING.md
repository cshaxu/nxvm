...
[Core Machine Instance Design](../etc/architecture-notes/core-machine-instance-design.md). That document
...
closure is [Core Machine Public-Surface Inventory](../etc/architecture-notes/core-machine-public-surface-inventory.md);
...
[C-Library Facade](../etc/architecture-notes/c-library-facade.md).
...
[M5 History](../etc/legacy-history/m5.md).
...
the [M5 closure checklist](../etc/governance/m5-closure-checklist.md).
...
[M5 History](../etc/legacy-history/m5.md). Current work must meet this document's
