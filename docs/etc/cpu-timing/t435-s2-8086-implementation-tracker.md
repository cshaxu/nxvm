...
The manifest also generates 289 first-order prefix/formula context keys:
244 `LOCK`, 33 `SEGMENT`, and 12 `ODD-WORD`. Their current strict baseline is
220 `unallocated` and 69 `missing-input`. Combined legal axes and repeat
phases are generated by the later B3/B4 runtime result consumer; they cannot
be marked conforming by this static audit.

It additionally generates 257 canonical combined/phase keys: `LOCK` crossed
with segment/odd-word where legal, and every legal REP family crossed with
...
| single-axis context | 273 | 16 | 289 | 0 | 220 | 69 | 0 |
| combined/phase context | 257 | 0 | 257 | 0 | 19 | 196 | 42 |
| **all generated keys** | **758** | **32** | **790** | **10** | **301** | **265** | **214** |
