...
522 exact base/context recipes through retirement observation, including all
...
It also observes INTO-taken next-byte lengths 1 through 6. It writes no result
artifact until
