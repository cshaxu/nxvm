...
424 exact base/context recipes through retirement observation, including all
...
forms and seven legal LOCK memory-RMW forms, plus all eighteen REP forms across
...
state and the protected-mode MOV-Sreg, LEA, LDS and LES memory base forms. It
writes no result artifact until
