...
534 exact base/context recipes through retirement observation, including all
...
6, plus indirect near-CALL next-byte lengths 1 through 6. It writes no result
artifact until
