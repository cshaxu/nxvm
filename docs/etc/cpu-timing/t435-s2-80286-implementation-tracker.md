...
372 exact base/context recipes through retirement observation, including all
...
forms and one legal LOCK memory-RMW form. It writes no result artifact until
