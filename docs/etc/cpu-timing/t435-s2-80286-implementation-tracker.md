...
484 exact base/context recipes through retirement observation, including all
...
forms and two real-mode segment-register odd-address forms. It writes no
result artifact until
