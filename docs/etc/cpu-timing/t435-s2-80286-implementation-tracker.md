...
378 exact base/context recipes through retirement observation, including all
...
forms and seven legal LOCK memory-RMW forms. It writes no result artifact until
