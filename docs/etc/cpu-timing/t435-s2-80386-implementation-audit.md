...
[Intel ledger](t435-s1-80386-ledger.md) into 402 all-L3 base keys. The current
...
conforming: 234 keys lack a focused result, while 168 dynamic/path/privilege
keys lack one or more normalized inputs. No L2 or L1 is permitted by S1.

The manifest generates 830 legal size, repeat-phase, multiplier, segment and memory-RMW
