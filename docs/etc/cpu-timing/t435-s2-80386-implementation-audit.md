...
[Intel ledger](t435-s1-80386-ledger.md) into 368 all-L3 base keys. The current
...
conforming: 234 keys lack a focused result, 133 dynamic/path/privilege keys
...
The manifest generates 832 legal size, repeat-phase, multiplier, segment and memory-RMW
