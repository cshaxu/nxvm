...
[Intel ledger](t435-s1-80286-ledger.md).  It freezes 290 L3 base keys; 80286
...
The strict manifest baseline is 290 base keys: 238 `missing-test` and 52
`missing-input`; zero is conforming, wrong-value or unallocated. It also
generates 460 legal single-axis keys and 62 legal combined keys. `EA-BID`,
