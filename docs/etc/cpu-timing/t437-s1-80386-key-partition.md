...
| --- | --- | --- |
| S3 | ordinary compatible/80386 arithmetic, data movement, multiply/divide, shifts, bit forms, flags, SETcc and XLAT | every corresponding base and inherited size, segment, LOCK and multiplier key |
| S4 | direct and string I/O, primitive strings and REP strings | every phase, override and size key for those forms |
| S5 | ordinary stack, conditional branches, non-taken INTO, real-mode direct/indirect transfer and real interrupt paths | every outcome, next-component and inherited context key for those forms (234 keys after the S5 correction below) |
...
S8 owns no unimplemented form. It consumes the already partitioned 1,410-key
...
```text
M5:T437:S1:I386-PARTITION-COMPLETE:PASS:canonical=1410
