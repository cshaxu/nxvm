...
`M5:T485:S19:8088-TABLE-2-21-COVERAGE-INVENTORY:ACCEPTANCE-CANDIDATE`
...
| LOCK; REP/REPE/REPNE prefix rows | REP is covered only where the string receiver owns its legal executed primitive. LOCK's source prefix term and legal-base qualification have no 8088 receiver; a prefix alone is not a successful instruction row | Prefix-qualified batch; do not add it to compatibility |
