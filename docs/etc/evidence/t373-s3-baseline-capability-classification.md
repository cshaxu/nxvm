...
| **PC/XT 5160-268 -- 8088, 256 KB, enhanced keyboard, one half-height FDD, no fixed disk** | Empty as a machine composition. NXVM has an 8086 contract but no distinct 8088 profile, XT descriptor, board binding, keyboard/FDC topology, ROM mapping or 5160 reset/IRQ/DMA route. The exact drive type and board oscillator relationship remain source-unknown. | [8088 CPU-profile admission/timing closure](../../proposals/m5-8088-cpu-profile.md), then the [closed XT 5160-268 profile/capability audit](../../history/M5-T483-xt-5160-268-profile-capability-audit-proposal.md) before [XT selected-device functional closure](../../proposals/m5-xt-5160-268-device-functional-closure.md). | [XT board/device phase-timing closure](../../proposals/m5-8088-5150-xt-l3-baseline.md), then [XT final audit](../../proposals/m5-xt-5160-268-l3-audit.md). |
