...
| --- | --- | --- | --- |
| **5170 Model 339 -- 80286, 8 MHz** | Partial. Shared 80286 contract and accepted successful-retirement ledger exist, but the selected machine still lacks source-backed wait/bus availability integration and no full selected-profile functional proof exists. | [5170 selected-device functional closure](../../history/M5-T374-5170-selected-device-functional-closure-proposal.md), consuming the prior 80286 transfer ledger without reopening a settled row. | [5170 board/device phase-timing closure](../../history/M5-T375-5170-board-phase-timing-closure-proposal.md), then [5170 final audit](../../proposals/m5-5170-final-l3-audit.md). |
