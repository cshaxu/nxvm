...
| --- | --- | --- | --- |
| **5170 Model 339 -- 80286, 8 MHz** | Partial. Shared 80286 contract and accepted successful-retirement ledger exist, but the selected machine still lacks source-backed wait/bus availability integration and no full selected-profile functional proof exists. | [5170 selected-device functional closure](../../history/M5-T374-5170-selected-device-functional-closure-proposal.md), consuming the prior 80286 transfer ledger without reopening a settled row. | [5170 board/device phase-timing closure](../../proposals/m5-5170-board-phase-timing-closure.md), then [5170 final audit](../../proposals/m5-5170-final-l3-audit.md). |
| **5170 -- 512 KB planar memory, Rev.3 abstract ROM slot, reset** | Partial. Checked memory, immutable mapping and logical reset path exist, but the selected board/ROM-slot/reset-visible configuration has not been proved as a complete Model-339 contract. External IBM ROM remains optional owner asset, not a Git/runtime dependency. | [5170 selected-device functional closure](../../history/M5-T374-5170-selected-device-functional-closure-proposal.md). | [5170 board/device phase-timing closure](../../proposals/m5-5170-board-phase-timing-closure.md), then final audit. |
| **5170 -- PIC, PIT, DMA, RTC/CMOS, parity/NMI routes** | Partial. Logical owners and selected ordering exist; T365/T366--T372 explicitly retain unselected NMI source/latch, full device state, and physical-board conversion gaps. | [5170 selected-device functional closure](../../history/M5-T374-5170-selected-device-functional-closure-proposal.md). | [5170 board/device phase-timing closure](../../proposals/m5-5170-board-phase-timing-closure.md), then final audit. |
| **5170 -- 101-key AT keyboard and 8042, IRQ1** | Partial. A bounded AT keyboard/8042 path exists, but selected-device command, buffer, reset and complete IRQ-visible behavior are not proven. AUX/mouse is not part of this baseline. | [5170 selected-device functional closure](../../history/M5-T374-5170-selected-device-functional-closure-proposal.md). | [5170 board/device phase-timing closure](../../proposals/m5-5170-board-phase-timing-closure.md), then final audit. |
| **5170 -- CGA digital display** | Partial. Model-339 selects CGA and the VADP path exists, but the exposed CGA register/mode/state/reset behavior and contention/cadence are not complete evidence. EGA is expressly not selected. | [5170 selected-device functional closure](../../history/M5-T374-5170-selected-device-functional-closure-proposal.md). | [5170 board/device phase-timing closure](../../proposals/m5-5170-board-phase-timing-closure.md), then final audit. |
| **5170 -- FDC, IRQ6/DMA2 and aftermarket 1.44 MB field upgrade** | Partial. Bounded FDC, BIOS and DOS boot paths exist, but controller/drive state, error/reset and selected field-upgrade behavior are not complete; the drive remains aftermarket, not a factory 339 fact. | [5170 selected-device functional closure](../../history/M5-T374-5170-selected-device-functional-closure-proposal.md). | [5170 board/device phase-timing closure](../../proposals/m5-5170-board-phase-timing-closure.md), then final audit. |
...
| **DeskPro Model 40 -- 80386 at 16 MHz, 1 MB, 128 KB ROM, keyboard, 1.2 MB FDD, 40 MB fixed disk** | Empty as a machine composition: the shared 80386 contract and generic PC/AT mechanisms exist, but no DeskPro descriptor, board binding, ROM mapping, keyboard/controller, FDC, fixed-disk controller/interface, reset or IRQ/DMA topology exists. The listed product facts do not select undocumented controller details. | [DeskPro Model 40 profile/capability audit](../../proposals/m5-deskpro-386-model40-profile-capability-audit.md) first chooses source-backed board/device facts; then [DeskPro 80386 CPU closure](../../proposals/m5-deskpro-386-profile-cpu-closure.md) and [DeskPro selected-device functional closure](../../proposals/m5-deskpro-386-model40-device-functional-closure.md). | [DeskPro board/bus/device timing closure](../../proposals/m5-deskpro-386-bus-device-closure.md), then [DeskPro final audit](../../proposals/m5-deskpro-386-l3-audit.md). |
| **DeskPro Model 40 -- display adapter** | Source-unknown/unselected. The locked model name and product facts do not select a display adapter; generic EGA and Model-339 CGA are not substitutes. | [DeskPro Model 40 profile/capability audit](../../proposals/m5-deskpro-386-model40-profile-capability-audit.md) must select a primary-documented adapter or explicitly narrow the corpus. | Only after selection: DeskPro functional closure, then board/bus/device timing closure and final audit. |
| **DeskPro Model 40 -- PIC/PIT/DMA/RTC/NMI** | Empty as a DeskPro-specific board binding. Shared logical owners are not evidence of Compaq chip/revision/route/reset behavior. | [DeskPro Model 40 profile/capability audit](../../proposals/m5-deskpro-386-model40-profile-capability-audit.md), then DeskPro selected-device functional closure. | [DeskPro board/bus/device timing closure](../../proposals/m5-deskpro-386-bus-device-closure.md), then final audit. |
| **PC/XT 5160-268 -- 8088, 256 KB, enhanced keyboard, one half-height FDD, no fixed disk** | Empty as a machine composition. NXVM has an 8086 contract but no distinct 8088 profile, XT descriptor, board binding, keyboard/FDC topology, ROM mapping or 5160 reset/IRQ/DMA route. The exact drive type and board oscillator relationship remain source-unknown. | [8088 CPU-profile admission/timing closure](../../proposals/m5-8088-cpu-profile.md), then [XT 5160-268 profile/capability audit](../../proposals/m5-xt-5160-268-profile-capability-audit.md) before [XT selected-device functional closure](../../proposals/m5-xt-5160-268-device-functional-closure.md). | [XT board/device phase-timing closure](../../proposals/m5-8088-5150-xt-l3-baseline.md), then [XT final audit](../../proposals/m5-xt-5160-268-l3-audit.md). |
| **PC/XT 5160-268 -- display adapter** | Source-unknown/unselected. A system-unit description does not choose MDA, CGA, or another adapter. | [XT 5160-268 profile/capability audit](../../proposals/m5-xt-5160-268-profile-capability-audit.md) must select documented display/corpus facts. | Only after selection: XT functional closure, then XT timing closure and final audit. |
| **PC/XT 5160-268 -- PIC/PIT/DMA/RTC/NMI/reset** | Empty as an XT-specific board binding; shared PC/AT logical owners are not XT implementation evidence. | [XT 5160-268 profile/capability audit](../../proposals/m5-xt-5160-268-profile-capability-audit.md), then XT selected-device functional closure. | [XT board/device phase-timing closure](../../proposals/m5-8088-5150-xt-l3-baseline.md), then final audit. |
