...
| Paging and translation | Non-PAE translation, protection, `#PF`, invalidation, and diagnostics compose with the exception and privilege paths. | In progress: T325 S1 corrects CR0/page-protection semantics; S2 closes direct CR2/CR3 directory selection and the no-persistent-TLB functional boundary. Remaining task/VM86 paging and any persistent-TLB/test-register model retain named transfers. | 80386DX paging and translation closure; T325 S1/S2 evidence. |
