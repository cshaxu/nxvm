...
| VM86-to-protected delivery | VM86 `#GP`, `#UD`, `#NM`, and IRQ delivery cross an IDT gate onto a TSS-selected CPL0 stack with an Intel-correct frame and bounded return. | Planned; individual VM86 classifications do not establish this transition. | VM86-to-protected exception and interrupt delivery foundation. |
