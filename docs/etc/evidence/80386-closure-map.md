...
| Task, LDT, debug, and VM86 breadth | Task/LDT state, remaining VM86 instructions, debug/test-register behavior, and their transfer/fault boundaries compose. | Partial: T329 S1--S5 close 16/32-bit direct far-JMP/CALL images, GDT/IDT task-gate entry, backlink/NT, bounded nested IRET return, and the admitted fault order including a bounded double-fault task-gate chain. Non-null LDT, task paging, and debug breadth remain open. | [T329 S1 direct-TSS evidence](t329-s1-tss16-direct-jump.md), [S2 evidence](t329-s2-tss32-direct-jump.md), [S4 entry evidence](t329-s4-task-gate-call-entry.md), [S5 evidence](t329-s5-task-return-idt-task-gate.md), and [the state-machine record](t329-task-switch-state-machine.md); S6 owns non-null LDT and S7 task paging/debug composition. |
