...
| --- | --- | --- | --- |
| Real and ordinary execution | Profile gates, operand/address attributes, ordinary faults, and deterministic instruction/IRQ ordering compose in real mode. | Partial; T316 closed bounded ordinary form slices only. | 80386DX ordinary execution and flag-completeness foundation; legacy LOCK debt for 80186/80286. |
