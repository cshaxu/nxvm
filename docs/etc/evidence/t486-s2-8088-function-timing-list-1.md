...
| HLT; IDIV; IMUL; IN; INC; INT; INTO; IRET | HLT `2/-`; IDIV/IMUL F4; IN immediate `10/1`, DX `8/1`; INC reg16 `2/-`, reg8 `3/-`, memory `15+EA/2`; INT type3 `52/5`, other `51/5`; INTO `53 or 4/5`; IRET `24/3`; pp. 2-55 through 2-56. |
