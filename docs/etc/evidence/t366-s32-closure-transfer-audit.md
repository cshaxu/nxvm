...
| --- | --- | --- |
| Complete 80286 successful-retirement source ledger, including prefixed and default/unallocated forms and all remaining system/control families | [80286 successful-retirement timing closure](../history/retired-machine-plans/m5-80286-retirement-timing-closure.md), using the shared [four-profile CPU-completeness program](../history/retired-machine-plans/m5-four-profile-cpu-completeness-program.md). | S9/S10 prove `elapsed_ticks` still receives successful unallocated values; the accepted rows do not define a global physical 8 MHz clock. |
| CPU memory/I/O waits, READY, DMA HOLD/HLDA-style exclusion, arbitration, INTA distinction, and transaction availability/cancellation trace | T369 closes logical HOLD/transaction availability; physical waits and INTA distinctions transfer to closed T371 [selected-profile phase refinement](../../history/M5-T371-selected-profile-phase-refinement-proposal.md). [Retained T369 proposal](../../history/M5-T369-bus-timed-pcat-operation-proposal.md). | T366 records no selected physical bus availability contract or numeric wait-state source. |
| PIT/PIC/RTC/DMA/KBC/PPI/NMI/CGA/FDC busy/ready, DRQ/IRQ, reset/cancel and command-service timing; uPD765 clock-domain conversion | Closed T370 [PC/AT device service-timing corpus](../../history/M5-T370-pcat-device-service-timing-corpus-proposal.md). | S8 explicitly prohibits translating controller milliseconds through retirement ticks. |
| CPU prefetch, bus-phase and device-microstate representation for the fixed selected profile | Closed T371 [Selected-profile model-L3 phase refinement](../../history/M5-T371-selected-profile-phase-refinement-proposal.md). | No complete source-labelled CPU/bus/device phase model exists. |
| Component-by-component 5170 ready/not-ready decision | [M5 L3 machine closure audit](../../history/M5-T372-ibm-5170-model-l3-closure-audit-proposal.md), after the preceding work. | This audit cannot substitute for implementation and must decide readiness from its full evidence matrix. |
