...
| CPU memory/I/O waits, READY, DMA HOLD/HLDA-style exclusion, arbitration, INTA distinction, and transaction availability/cancellation trace | [Bus-timed PC/AT operation](../../proposals/m5-bus-timed-pcat-operation.md), after the 80286 successful-retirement timing closure. | T366 records no selected physical bus availability contract or numeric wait-state source. |
