# NXVM Baseline: 6d6b7d7

- Reference repository: sibling `../nxvm`.
- Remote: `https://github.com/cshaxu/nxvm.git`.
- Commit: `6d6b7d70ab6ed83ab973d27aeea6db88f4e87e4f`.
- Upstream checkout license at capture: LGPL-3.0-or-later.
- Effective ntvdm64 import license: root MIT under NXVM copyright-holder
  authorization; see `docs/etc/operations/policy/source-policy.md`.
...
`docs/etc/research/provenance/nxvm-imports.md`. The sibling checkout remains read-only.
