...
| IBM *PC/AT Technical Reference* 1502243, March 1984, local `O:/assets/manuals/controllers/ibm/IBM_5170_Technical_Reference_1502243_Mar1984.pdf`, system-board I/O/IRQ/CMOS and BIOS fixed-disk sections | Primary OCR text; tables are legible enough to transcribe but every numeric row is tied to its printed table. | AT integration facts, CMOS types and firmware vectors. |
