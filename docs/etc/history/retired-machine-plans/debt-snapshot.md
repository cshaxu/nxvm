# Former Product Debt Snapshot

> Historical input, not current debt or completion evidence. See [disposition](README.md).
> Wording below is preserved from the pre-consolidation ledger.
...
allocate a task identifier, or override [CURRENT.md](../../../states/CURRENT.md). Current goals,
candidate work, and detailed capability evidence belong in
[design/GOAL.md](../../../design/GOAL.md), [QUEUE.md](../../../states/QUEUE.md), and
