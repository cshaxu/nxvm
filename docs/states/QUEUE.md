...
1. [Shared CPU state and delivery foundations](../proposals/m5-cpu-shared-state-delivery.md); [M5 80386DX admission policy](../proposals/m5-80386dx-candidate-policy.md).
