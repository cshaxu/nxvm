...
1. [VM native display resource lifetime repair](../proposals/m5-vm-native-display-resource-lifetime.md) (currently admitted; retained until closure moves its proposal to history).
