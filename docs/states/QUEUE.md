...
1. [DeskPro 386 physical-cycle and phase-timing closure](../proposals/m5-deskpro-physical-cycle-and-phase-timing.md) -- CPU BUSRDY completion is closed; re-admit only the next bounded receiver with original source, controller-matched reference, or owner-supplied corpus for its named blocker.
