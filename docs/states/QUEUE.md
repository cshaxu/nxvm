...
1. [VM request-bridge current-build restoration](../proposals/m5-vm-request-bridge-current-build-restoration.md).
1. [Parallel Console profile-smoke isolation](../proposals/m5-parallel-console-profile-smoke-isolation.md).
