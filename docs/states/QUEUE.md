...
1. [DeskPro 386 physical-cycle and phase-timing closure](../proposals/m5-deskpro-physical-cycle-and-phase-timing.md) -- physical/L3 acceptance is not ready; re-admit only a bounded, tier-labelled receiver with a new original source, controller-matched reference, or owner-supplied corpus for its named blocker.
