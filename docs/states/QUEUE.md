...
1. [Shared CPU state and delivery foundations](../proposals/m5-cpu-shared-state-delivery.md). Complete common delivery and rollback contracts before profile packages rely on them.
