...
1. [DeskPro 386 physical-cycle and phase-timing closure](../proposals/m5-deskpro-physical-cycle-and-phase-timing.md) -- original 1986 D3PE material now supports a bounded CPU BUSRDY completion receiver; the remaining physical/L3 decision stays blocked by its named inputs.
