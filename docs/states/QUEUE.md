...
The active PIC proposal remains linked while its admitted source-and-contract
inventory executes: [Core PIC 8259A phase contract](../proposals/m5-core-pic-8259a-phase-contract.md).
