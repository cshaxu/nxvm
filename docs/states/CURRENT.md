...
| --- | --- |
| Identifier Mode | Continuation; M5 T401 S29. |
| Admission And Approval | Owner approved continuing the four-profile CPU audit. S28 is accepted after complete ARPL execution/preview evidence. |
| Objective | Audit BOUND `62h` across 8086, 80186, 80286 and 80386: signed bounds, #BR delivery, prefix/profile gates, preview and retirement. |
...
| Expected Markers | New T401 S29 markers and any bounded defect marker. |
...
| Asset Needs | None. |
| Exit Criteria | Every selected `62h` profile/form row has focused proof or an explicit transfer; bounded repairs have full-gate proof. |
...
| Task | Compact result |
| --- | --- |
| T401 S28 | Accepted: ARPL audit closes 63h profile gates, RPL/ZF, memory/protected/IRQ and lexical component coverage. S29 owns BOUND. [Ledger](../etc/evidence/t401-s1-four-profile-cpu-audit-ledger.md). |
