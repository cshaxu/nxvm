...
| Task | Compact result |
| --- | --- |
| T466 S3 | Accepted: IBM EGA external routing and two-bit Sequencer Reset use the sole VADP/memory route; CECG remains separate by personality and unsupported clock/board terms remain L2. |
