...
| Task | Compact result |
| --- | --- |
| T401 S67 | Accepted: 80386 control-register MOV audit closes standard generic versus original-80386 private-preview classification and both-direction evidence; no production discrepancy. [Ledger](../etc/evidence/t401-s1-four-profile-cpu-audit-ledger.md). |
