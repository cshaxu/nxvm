...
| --- | --- |
| Identifier Mode | Continuation; M5 T401 S26. |
| Admission And Approval | Owner approved continuing the four-profile CPU audit. S25 is accepted after complete INT immediate execution/preview evidence. |
| Objective | Audit INT3 `CCh` and INTO `CEh` across 8086, 80186, 80286 and 80386: vector/overflow gates, stack frame, prefix/profile gates, preview and retirement. |
...
| Expected Markers | New T401 S26 markers and any bounded defect marker. |
...
| Asset Needs | None. |
| Exit Criteria | Every selected `CCh`/`CEh` profile/form row has focused proof or an explicit transfer; bounded repairs have full-gate proof. |
...
| Task | Compact result |
| --- | --- |
| T401 S25 | Accepted: INT immediate audit closes CDh profiles, vector/frame, prefix gates, protected/fault/VM86 and lexical component coverage. S26 owns INT3/INTO. [Ledger](../etc/evidence/t401-s1-four-profile-cpu-audit-ledger.md). |
