...
| Task | Compact result |
| --- | --- |
| T456 S3 | Accepted: one PIC-local ICW1.SNGL/ICW3 relation now drives selection, SFNM and refresh; AT/default, programmed, mismatch, single-mode and reinitialization proof pass, with an isolated full current-gate replay at 293/293. [Evidence](../etc/evidence/t456-s3-pic-programmed-cascade-contract.md). |
