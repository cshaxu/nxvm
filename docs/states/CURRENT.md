...
| --- | --- |
| Identifier Mode | Continuation; M5 T401 S32. |
| Admission And Approval | Owner approved continuing the four-profile CPU audit. S31 is accepted after complete PUSHA/POPA execution/preview evidence. |
| Objective | Audit LAR/LSL `0F02h`/`0F03h` across 8086, 80186, 80286 and 80386: descriptor access, flags, profile gates, preview and retirement. |
...
| Expected Markers | New T401 S32 markers and any bounded defect marker. |
...
| Asset Needs | None. |
| Exit Criteria | Every selected `0F02h`/`0F03h` profile/form row has focused proof or an explicit transfer; bounded repairs have full-gate proof. |
...
| Task | Compact result |
| --- | --- |
| T401 S31 | Accepted: PUSHA/POPA audit closes 60h/61h profiles, stack images, prefix gates, protected limits/IRQ and lexical coverage. S32 owns LAR/LSL. [Ledger](../etc/evidence/t401-s1-four-profile-cpu-audit-ledger.md). |
