...
| --- | --- |
| T375 S15 | Accepted P1 `690c335c`: Model-339's selected Rev.3 slot now programs its 80-column CGA CRTC defaults through the existing firmware-port route; generic EGA remains contained. This does not close other mode tables, physical timing or 5170 L3. [Evidence](../etc/evidence/t375-s15-model339-rev3-cga-defaults.md). |
