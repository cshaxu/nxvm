...
**Current progress:** T388 S3 is accepted: Core now preserves deterministic
elapsed progression while explicitly prohibiting unallocated successful
retirements from entering a physical CPU-clock contract. Its
[evidence](../etc/evidence/t388-s3-physical-eligibility-boundary.md) and
static boundary gate retain the classifier-to-sole-publisher proof. No profile
...
| Task | Compact result |
| --- | --- |
| T388 S3 | Accepted: P1/P2 add and statically guard the Core-owned physical-eligibility boundary: exact source costs retain deterministic progress, while an unallocated successful retirement is rejected before sole publication under the typed physical contract. No profile is physically enabled; source/form/context allocation or approved observations remain open. [Evidence](../etc/evidence/t388-s3-physical-eligibility-boundary.md). |
