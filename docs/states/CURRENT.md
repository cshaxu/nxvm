...
| --- | --- |
| Identifier Mode | T366 S26, numbered continuation implementation subtask; P1 is one complete pushed implementation/evidence delivery. |
| Admission And Approval | The owner approved continued L3 work on 2026-08-14. T366 admits only source-determinate successful protected 80286 `0F 00 /4,/5 VERR/VERW r/m16` forms. |
| Objective | Publish Intel Appendix-B fixed register 14 and memory 16 clock costs through the sole retirement owner. |
| Non-goals | No real mode, prefix, memory fault, delivery, descriptor repair, LSL, LLDT/LTR, bus/physical-time or device work. |
| Reference Baseline | `1d5fb9c4`, Intel [80286 Appendix-B VERR/VERW](https://manualsdump.com/en/manuals/intel-80287model-80286model/110730/321), and the T366 proposal. |
...
| Applicable Rules | Execution: complete pushed P and sweep. Architecture: one retirement publisher. Coding: owner-local classifier. Documentation: truthful state. Source policy: read-only manual evidence; no import/assets. |
| Verification | Focused protected register/direct/indexed VERR/VERW timing and ZF outcomes; semantic smoke, current smokes, governance and diff check. |
...
| Exit Criteria | Pushed P proves only successful unprefixed protected VERR/VERW retirement publishes 14/16 ticks with transfers retained. |
| Original Owner Request | Continue until comprehensive L3 closure before Windows 3.1; primary Intel authority first. |
| Similar-Issue Sweep | Audit `INS_0F_00`, mode/ModR/M/prefix legality, VERR/VERW ZF outcomes, timing classifiers and sole tick publisher. |
...
| Task | Compact result |
| --- | --- |
| T366 S25 | Accepted at `f2e90047`: successful unprefixed protected 80286 `ARPL r/m16,r16` publishes the source-backed fixed register/memory 10/11 ticks through the existing retirement owner. Real mode, prefix, null-selector, fault, delivery, bus and physical-time timing remain transferred. [Timing evidence](../etc/evidence/t366-s25-80286-arpl-timing.md). |
