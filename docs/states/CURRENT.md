...
**Idle.** M5 T347 storage controller service timing is accepted and closed; the
next PC/AT device-completeness candidate requires a separately admitted packet.
