...
| --- | --- |
| Identifier Mode | Continuation; M5 T401 S16. |
| Admission And Approval | Owner approved continuing the four-profile CPU audit. S15 is accepted after complete MOVS execution/preview evidence. |
| Objective | Audit primary CMPS (`A6h`/`A7h`) across 8086, 80186, 80286 and 80386: byte/word/dword forms, DF and segment routing, repeat, prefix/profile gates, flags, preview and retirement. |
...
| Expected Markers | New T401 S16 markers and any bounded defect marker. |
...
| Asset Needs | None. |
| Exit Criteria | Every selected `A6h`/`A7h` profile/form row has focused proof or an explicit transfer; bounded repairs have full-gate proof. |
...
| Task | Compact result |
| --- | --- |
| T401 S15 | Accepted: MOVS audit closes A4h/A5h four-profile execution/preview, REP/DF, attribute and prefix gates. S16 owns CMPS. [Ledger](../etc/evidence/t401-s1-four-profile-cpu-audit-ledger.md). |
