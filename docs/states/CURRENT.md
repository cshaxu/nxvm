...
| Task | Compact result |
| --- | --- |
| T359 S3 | Private four-profile control/stack classifier at that same publisher; it allocates successful real-mode direct/indirect control, stack, loop, HLT, INT/INTO/IRET rows, transfers protected/physical transitions, and reconciles timing consumers. [Evidence](../etc/evidence/t359-s3-four-profile-control-stack-source-ledger.md). |
