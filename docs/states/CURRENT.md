...
**T386 open; S1--S12 accepted.** S12 makes the primary-backed Compaq CECG
`3C2h` bit-0 color/monochrome I/O-base selection VADP-owned. Private Model-40
composition supplies only the color-base reset declaration; the accepted
controls prove selected CRTC/status/Feature/light-pen routing, reset
restoration and generic-EGA isolation. `3x8/3x9` routing, remaining `3C2h`
effects, firmware, physical board behavior and L3 timing remain explicit
receivers in `TODO.md` and the T386 proposals.
