...
**T386 open; S1--S14 accepted.** S14 replaces the false contiguous private
Model-40 ROM carrier with the primary-backed two-chip odd/even 16 KiB carrier,
mirrored 64 KiB F0000h window and VM-owned A20 reset alias. Core retains its
unchanged generic immutable-ROM and A20 behavior. This is private functional
progress only: it does not admit a public firmware loader, real-ROM execution,
ROM shadowing, physical-board behavior, timing or Model-40 L3.
