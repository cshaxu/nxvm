...
| --- | --- |
| Identifier Mode | Continuation; M5 T401 S17. |
| Admission And Approval | Owner approved continuing the four-profile CPU audit. S16 is accepted after complete CMPS execution/preview evidence. |
| Objective | Audit primary STOS (`AAh`/`ABh`) across 8086, 80186, 80286 and 80386: byte/word/dword forms, DF and ES destination routing, repeat, prefix/profile gates, flags preservation, preview and retirement. |
...
| Expected Markers | New T401 S17 markers and any bounded defect marker. |
...
| Task | Compact result |
| --- | --- |
| T401 S16 | Accepted: CMPS audit closes A6h/A7h four-profile execution/preview, flags, REP condition, DF, segment, attribute and prefix gates. S17 owns STOS. [Ledger](../etc/evidence/t401-s1-four-profile-cpu-audit-ledger.md). |
