...
| --- | --- |
| T375 S11 | Accepted P1 `f1e75eda`: VADP now owns source-backed CGA non-interlaced R0--R7/R9 logical raster state, reset/status/snapshot proof, and preserves adjacent EGA routes. Physical character-clock publication, board phase and Model-339 L3 remain open. [Evidence](../etc/evidence/t375-s11-cga-logical-raster.md). |
