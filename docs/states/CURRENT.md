...
| --- | --- |
| Identifier Mode | Continuation; M5 T401 S27. |
| Admission And Approval | Owner approved continuing the four-profile CPU audit. S26 is accepted after complete INT3/INTO execution/preview evidence. |
| Objective | Audit IRET `CFh` across 8086, 80186, 80286 and 80386: return frame, flags/privilege restoration, prefix/profile gates, preview and retirement. |
...
| Expected Markers | New T401 S27 markers and any bounded defect marker. |
...
| Asset Needs | None. |
| Exit Criteria | Every selected `CFh` profile/form row has focused proof or an explicit transfer; bounded repairs have full-gate proof. |
...
| Task | Compact result |
| --- | --- |
| T401 S26 | Accepted: INT3/INTO audit closes CCh/CEh profiles, vector/overflow gates, prefix gates, protected/fault/VM86 and lexical component coverage. S27 owns IRET. [Ledger](../etc/evidence/t401-s1-four-profile-cpu-audit-ledger.md). |
