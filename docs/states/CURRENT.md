...
| --- | --- |
| Identifier Mode | Continuation; M5 T401 S33. |
| Admission And Approval | Owner approved continuing the four-profile CPU audit. S32 is accepted after complete LAR/LSL execution/preview evidence. |
| Objective | Audit LES/LDS `C4h`/`C5h` across 8086, 80186, 80286 and 80386: far-pointer loads, profile gates, preview and retirement. |
...
| Expected Markers | New T401 S33 markers and any bounded defect marker. |
...
| Asset Needs | None. |
| Exit Criteria | Every selected `C4h`/`C5h` profile/form row has focused proof or an explicit transfer; bounded repairs have full-gate proof. |
...
| Task | Compact result |
| --- | --- |
| T401 S32 | Accepted: LAR/LSL audit closes descriptor/profile/VM86/IRQ behavior and lexical coverage. S33 owns LES/LDS. [Ledger](../etc/evidence/t401-s1-four-profile-cpu-audit-ledger.md). |
