...
| --- | --- |
| Identifier Mode | Continuation; M5 T401 S25. |
| Admission And Approval | Owner approved continuing the four-profile CPU audit. S24 is accepted after complete ENTER/LEAVE execution/preview evidence. |
| Objective | Audit INT immediate `CDh` across 8086, 80186, 80286 and 80386: vector dispatch, stack frame, prefix/profile gates, preview and retirement. |
...
| Expected Markers | New T401 S25 markers and any bounded defect marker. |
...
| Asset Needs | None. |
| Exit Criteria | Every selected `CDh` profile/form row has focused proof or an explicit transfer; bounded repairs have full-gate proof. |
...
| Task | Compact result |
| --- | --- |
| T401 S24 | Accepted: ENTER/LEAVE audit closes C8/C9 profiles, nesting, stack widths, faults and lexical component coverage. S25 owns INT imm8. [Ledger](../etc/evidence/t401-s1-four-profile-cpu-audit-ledger.md). |
