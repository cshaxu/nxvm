...
| Task | Compact result |
| --- | --- |
| T401 S62 | Accepted: 80386 SHLD/SHRD audit closes count, direction, destination, attribute and pre-80386 classification evidence; no production discrepancy. [Ledger](../etc/evidence/t401-s1-four-profile-cpu-audit-ledger.md). |
