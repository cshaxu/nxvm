...
| --- | --- |
| Identifier Mode | Continuation; M5 T401 S28. |
| Admission And Approval | Owner approved continuing the four-profile CPU audit. S27 is accepted after complete IRET execution/preview evidence. |
| Objective | Audit ARPL `63h` across 8086, 80186, 80286 and 80386: 80286+ semantics, legacy #UD, prefix/profile gates, preview and retirement. |
...
| Expected Markers | New T401 S28 markers and any bounded defect marker. |
...
| Asset Needs | None. |
| Exit Criteria | Every selected `63h` profile/form row has focused proof or an explicit transfer; bounded repairs have full-gate proof. |
...
| Task | Compact result |
| --- | --- |
| T401 S27 | Accepted: IRET audit closes CFh profiles, return/privilege frames, prefix gates, protected/outer/VM86 and lexical component coverage. S28 owns ARPL. [Ledger](../etc/evidence/t401-s1-four-profile-cpu-audit-ledger.md). |
