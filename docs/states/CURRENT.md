...
**T394 S6 accepted.** The complete C0 81-key set remains nonphysical until the source-backed DeskPro board clock-plan/consumer contract exists; Core qualification and rejection boundaries are ready for that receiver.
