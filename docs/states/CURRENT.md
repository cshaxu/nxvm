...
| Task | Status | Scope |
| --- | --- | --- |
| T528 | Between S tasks | [M5 VM-machine owner cleanup](../proposals/m5-vm-machine-owner-cleanup.md): S1--S4 accepted; a separate profile/firmware-owner audit remains before any relocation. Executor workers are explicitly outside this task's current scope. |
