...
including the sole port ingress, PIT state and output-consumer route.
Implementation consumes the complete gap batch through that route and proves
deadline/order; it may not add an XT-specific PIT state machine or scheduler
path.
