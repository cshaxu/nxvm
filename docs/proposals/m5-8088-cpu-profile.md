...
source-backed 8088 differences required by the selected 5150/XT corpus. The
...
selected 5150/XT contract, no copied emulator code, and no Windows claim. Stop
...
an explicit handoff to the 5150/XT profile. Where primary material gives only a
