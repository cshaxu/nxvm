...
| S8 / 80186 | Implement exact/formula keys and declared midpoint L2 keys, including 80186-only forms and legal contexts | every 80186 S2 key is conforming; no endpoint/constrained legacy arithmetic path remains |
| S9 / 80286 | Implement all L3 forms including real/PM, privilege/gate/task, EA/odd word, next-byte and repeat inputs | every 80286 S2 key is conforming; no successful fallback remains |
| S10 / 80386DX | Implement all L3 forms including size, VM86/PM, system forms, early-out multiply and r/m/repeat contexts | every 80386DX S2 key is conforming; formula/path inputs are published and checked |
| S11 / B4 | Cross-profile result consumption, obsolete-selector removal and closure audit | zero nonconforming key across four manifests; focused and cross-profile regressions pass |
