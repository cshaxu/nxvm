...
> Archived from Current at `2cc11c2a0` during MyNES-hosted T43 S11.
> All pending stages, old hashes, task labels and scope language below are
> historical quotations, not active instructions. T41 is closed. See
> [Current](../states/CURRENT.md) for the live baseline. Only broken links and
> accidental control characters were corrected during archival.

## Current Work

MyNES-hosted T43 S10 refreshes this product's eight current 0535 receiving
artifacts after the Shared byte-boolean change; [delivery evidence](../etc/evidence/m6-t43-s10-receiving-artifacts.md)
...
| S10 | Completed pending commit: versioned artifacts moved to assets/nxvm and assets/mynes; live CMake, delivery, documentation and ignore authorities changed with a dedicated root gate. Existing owner worktree changes are included. [Evidence](../etc/evidence/m6-t41-s10-product-artifact-root-rename.md) |
...
| Candidate Proposal | [M6 T41 shared type vocabulary convergence](../../mynes/history/retired-proposals/m6-t41-type-vocabulary-convergence.md) |
...
| Candidate Proposal | [M6 T41 S3 Lib Types facade-retirement design](M6-T41-s3-lib-types-facade-retirement-proposal.md) |
