...
This is the NXVM product documentation entry point. Shared governance is under
[`../rules/`](../rules/).

## Task Reading Set

Before changing NXVM work, every participant reads:
...
For NXVM orientation, read the current authorities in this order:
