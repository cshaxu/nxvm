...
received by the [Core L3 integration and VM contract export proposal](../history/retired-machine-plans/m5-core-l3-integration-vm-contract-export.md): every selected
