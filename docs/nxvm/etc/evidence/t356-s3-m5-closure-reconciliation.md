...
| CPU instruction time | `clock.c` consumes executor elapsed ticks but no profile/form cost ledger exists. | Open: [instruction-timed execution](../history/retired-machine-plans/m5-instruction-timed-execution.md) is first receiver. |
