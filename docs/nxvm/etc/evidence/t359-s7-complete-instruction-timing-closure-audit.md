...
| Faults, rejected prefix/LOCK forms, exception/IRQ/NMI, task gate/switch, cross-privilege return/entry, and VM86 frame delivery | Closed T371 [Cycle-exact selected profile](../../history/M5-T371-selected-profile-phase-refinement-proposal.md) | These are delivery or transition mechanisms, not successful instruction retirement. |
| Memory/I/O waits, HOLD/DMA ownership, prefetch/cache/alignment, pin phases | T369 logical HOLD/DMA ownership, then closed T371 [cycle-exact selected profile](../../history/M5-T371-selected-profile-phase-refinement-proposal.md) | They require a physical transaction contract rather than a processor table row. [Retained T369 proposal](../../history/M5-T369-bus-timed-pcat-operation-proposal.md). |
| Device command/service latency | Closed T370 [PC/AT device service-timing corpus](../../history/M5-T370-pcat-device-service-timing-corpus-proposal.md) | Device execution is distinct from CPU instruction retirement. |
