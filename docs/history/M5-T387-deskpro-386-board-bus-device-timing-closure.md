...
precedes the [DeskPro board-level timing closure](M5-T396-deskpro-386-board-level-timing-closure-proposal.md), which precedes the [DeskPro physical-device and firmware-timing closure](../proposals/m5-deskpro-386-physical-device-firmware-timing-closure.md),
