# M5 T390: 80386 Physical-Retirement Qualification

## Task Record

T390 owns the shared-Core prerequisite discovered by T389: it must qualify the
selected 80386 successful-retirement forms and contexts before the Model-40 may
publish CPU time into a physical board-clock domain. It consumes T388's safety
contract, which remains mandatory for every unqualified success. T390 precedes
the fresh DeskPro board-level timing candidate and makes no board ratio,
physical-device, firmware, ROM/media or L3 claim by itself.
...
S1 maps the sole post-refresh 80386 classifier chain to retained Intel-primary
ledgers and T388's physical rejection boundary. The retained
[inventory](../etc/evidence/t390-s1-80386-physical-qualification-inventory.md)
finds exact selected rows plus explicit prefix/default/context fallbacks, and
finds no Model-40 external-ROM execution corpus in the current source or gate.
...
### S11-S34 Evidence Index

The detailed accepted evidence is retained per subtask: [S11](../etc/evidence/t390-s11-rcl-register-one.md), [S12](../etc/evidence/t390-s12-lahf-qualification.md), [S13](../etc/evidence/t390-s13-corpus-checkpoint.md), [S14](../etc/evidence/t390-s13-corpus-checkpoint.md), [S15](../etc/evidence/t390-s15-rcl-cl.md), [S16](../etc/evidence/t390-s16-checkpoint-corpus-disposition.md), [S17](../etc/evidence/t390-s17-m40-c0-batch-capture.md), [S18](../etc/evidence/t390-s18-c0-batch-disposition.md), [S19](../etc/evidence/t390-s19-source-form-attribution.md), [S20](../etc/evidence/t390-s20-progress-cardinality-correction.md), [S21](../etc/evidence/t390-s21-c0-attribution-coverage-audit.md), [S22](../etc/evidence/t390-s22-classified-timing-origin.md), [S23](../etc/evidence/t390-s23-m40-c0-convergence-ledger.md), [S24](../etc/evidence/t390-s24-c0-exact-row-context-matrix.md), [S25](../etc/evidence/t390-s25-c0-context-capture.md), [S26](../etc/evidence/t390-s26-c0-control-context-corrective.md), [S27](../etc/evidence/t390-s27-c0-direct-row-regression.md), [S28](../etc/evidence/t390-s28-model40-physical-contract-selection.md), [S29](../etc/evidence/t390-s29-model40-rom-decode-correction.md), [S30](../etc/evidence/t390-s30-corrected-rom-c1-baseline.md), [S31](../etc/evidence/t390-s31-model40-a20-startup-baseline.md), [S32](../etc/evidence/t390-s32-c1-transition-boundary.md), [S33](../etc/evidence/t390-s33-post-c0-io-owner-boundary.md), and [S34](../etc/evidence/t390-s34-physical-retirement-scope-correction.md). S14 is the documentation corrective recorded in the S13 evidence; no separate evidence file exists.
