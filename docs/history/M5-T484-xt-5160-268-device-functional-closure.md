...
| S21 | In implementation: consume the frozen B6 contract through the sole typed session route, with validated external XT ROM mapping and fixed-profile media composition; no firmware/media import or board-timing claim. |
