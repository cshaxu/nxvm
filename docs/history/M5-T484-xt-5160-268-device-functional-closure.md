...
| S19 | In implementation: source-qualified IBM 5160 PPI-B parity/I/O-check controls and PPI-C status inputs use the sole XT PPI owner and one Core NMI request edge; physical fault generation/timing remains transferred. [Evidence](../etc/evidence/t484-s19-xt-ppi-parity-nmi.md). |
| S19 | In implementation: source-qualified IBM 5160 PPI-B parity/I/O-check controls and PPI-C status inputs use the sole XT PPI owner and one Core NMI request edge; physical fault generation/timing remains transferred. [Evidence](../etc/evidence/t484-s19-xt-ppi-parity-nmi.md). |
