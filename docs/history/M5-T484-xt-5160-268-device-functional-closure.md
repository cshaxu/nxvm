...
| S7 | Pending coordinator acceptance: rendered IBM 101/102-key source qualifies the selected serial, reset, response, PPI-line and IRQ contract for one future XT attachment, with no AT 8042 alias. [Evidence](../etc/evidence/t484-s7-xt-keyboard-source-contract.md). |
