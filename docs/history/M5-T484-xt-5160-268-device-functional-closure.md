...
| S9 | Active: IBM-led source contract selects one 360KiB `40 x 2 x 9 x 512` drive and the `3F2h`/`3F4h`/`3F5h`, IRQ6/DMA2 route; it excludes a PC/AT `3F7h` alias and transfers physical service timing. [Evidence](../etc/evidence/t484-s9-xt-fdc-source-contract.md). |
