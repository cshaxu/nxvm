...
| S20 | In implementation: B6 source/session audit freezes the lawful external-ROM/BYOB manifest, selected XT profile and sole session/Core construction gap before product-route implementation. |
