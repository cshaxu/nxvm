...
| S6 | Pending coordinator acceptance: IBM-led B3 source/current-owner matrix proves the XT PPI/keyboard is not an AT 8042 alias and the FDC must not inherit AT `3F7h` or a 1.44 MB drive. [Evidence](../etc/evidence/t484-s6-xt-b3-source-owner-matrix.md). |
