...
| S10 | Active: one immutable XT drive-A/FDC Core-plan route binds `3F2h`/`3F4h`/`3F5h`, IRQ6/DMA2 and no `3F7h`; the source-backed physical timing transfer remains explicit. [Evidence](../etc/evidence/t484-s10-xt-fdc-plan-implementation.md). |
