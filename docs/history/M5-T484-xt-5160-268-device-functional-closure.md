...
| S12 | Active: qualify the complete selected Xebec source contract before an explicit Core personality can be designed; no ATA alias, guessed geometry or media/firmware import. |
