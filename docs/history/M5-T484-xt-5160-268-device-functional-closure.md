...
| S13 | Active: replace the universal task-file HDC plan shape with one tagged immutable Xebec-capable form and one DMA3/IRQ5 Core wiring seam, preserving every current personality. |
