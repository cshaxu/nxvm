...
| S11 | Implementing: selected CGA now enters only through the accepted VADP, `B8000h` and copied-snapshot owner; focused route and shared-CGA/AT regression proof pass, while physical timing remains transferred. [Evidence](../etc/evidence/t484-s11-xt-cga-plan-implementation.md). |
