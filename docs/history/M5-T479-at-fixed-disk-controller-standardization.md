...
| S5 | Accepted: the sole Core HDC owner has an IBM WD1003/ST-506 personality, exact 8 MHz step-selector representation and `3F6h` high-head state; Model 339 selects its one Type-3 disk while focused, retained and full current-gate regressions pass. Stripped Release 0479 is recorded in S5 evidence. |
