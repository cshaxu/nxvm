...
| S7 | In progress: the primary WD1007A-WAH ESDI ledgers establish a distinct AT-compatible controller, but no current immutable profile may select it; the source-backed receiver transfer is under review. |
