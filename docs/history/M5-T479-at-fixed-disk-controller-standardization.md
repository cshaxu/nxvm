...
| S6 | In progress: the primary IBM 5160-268/Xebec source and current-gap ledgers establish the non-task-file `320h`--`323h`, DMA3 and IRQ5 contract; Core implementation may proceed without inventing the separately queued XT profile/ROM receiver. |
