# M5 T382: Quality-Boundary Recovery
...
1. S1 - current-gate aggregate liveness.
2. S2 - Console dead-code retirement.
3. S3 - YAML memory-quantity boundary.
4. S4 - FDC topology smoke diagnostic lifetime.
