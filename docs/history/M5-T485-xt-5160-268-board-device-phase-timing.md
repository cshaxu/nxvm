...
| S17 | Acceptance candidate: the retained control/stack evaluator source-classifies all finite 8088 HLT/software-delivery rows, including the `CD 03` type-3 distinction; INTR/NMI remain excluded. [Evidence](../etc/evidence/t485-s17-8088-delivery-halting-source-evaluator.md). |
