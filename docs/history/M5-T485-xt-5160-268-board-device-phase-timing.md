...
| S16 | Acceptance candidate: rendered Table-2-21 rows establish complete HLT/software-delivery input facts for one existing control/stack receiver; INTR/NMI remain non-instruction exclusions. [Evidence](../etc/evidence/t485-s16-8088-delivery-halting-source-ledger.md). |
