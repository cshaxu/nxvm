...
| S4 | Implementation pending acceptance: the complete immutable 8253 personality batch is in the sole Core PIT owner; an independently reproduced unrelated current-gate failure blocks closure. |
