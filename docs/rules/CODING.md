...
current-versus-target inventory is [Module Layout](../design/CODING.md).
...
dependency graph remains [Module Layout](../design/CODING.md).

- [C-Library Facade](../etc/architecture-notes/c-library-facade.md) is the sole detailed
...
- The exact component dependency graph, public symbol prefixes,
  ...
  [Module Layout](../design/CODING.md) and
...
- Defect and compatibility fixes follow the mandatory similar-issue sweep in
  [Execution Policy](EXECUTION.md); do not apply a local patch
