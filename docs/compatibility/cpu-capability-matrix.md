...
| `x86.i386_protected_mode` | bounded partial evidence; not profile-claimable beyond the admitted 16-bit subset | T259 runs the 16-bit CPL3 gate/outer-`IRET`/delivered-`#GP` corpus under the 80386 profile | 32-bit frames/gates, CPL3 paging, generic IDT/hardware delivery, TSS I/O, task switching, and broader corpus |
