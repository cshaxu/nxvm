    ...
    C_INT decrement, lib_u32 source, lib_u32 destination)
{
    ...
    if (!failed) {
        ...
        failed |= !cmps_run(&state, code, bytes, 1u, &after, &diagnostic,
            ...
            (before.data.esi & 0xffff0000u) | (lib_u16)(expected_index - 0x10u)) ||
...
static C_INT cmps_test_single(C_VOID)
{
    ...
    static const lib_u8 cmpsb = 0xa6u;
    static const lib_u8 cmpsw = 0xa7u;
    static const lib_u8 cmpsd[] = {0x66u, 0xa7u};
    static const lib_u8 address32[] = {0x67u, 0xa6u};
    static const lib_u8 combined[] = {0x66u, 0x67u, 0xa7u};
    lib_u8 profile;
    ...
    lib_u8 width, C_INT address32, C_INT decrement)
{
    ...
    if (!failed) {
        ...
        failed |= after.data.esi != (address32 ? expected_source :
            ...
            (before.data.edi & 0xffff0000u) | (lib_u16)expected_destination);
        for (item = 0u; item != 3u; ++item)
...
static C_INT cmps_test_rep_attributes(C_VOID)
{
    ...
    static const lib_u8 reverse[] = {0xf3u, 0xa6u};
