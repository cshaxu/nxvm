...
static lib_i32 t285_write_byte(t_ram *memory, lib_u32 physical, lib_u8 value)
{
...
lib_i32 main(void)
{
    ...
    if (!failed) {
        printf("M5:T285:S3:EGA-MODE10:CONTRACT:OK\n");
        return 0;
    }
    fprintf(stderr, "M5:T285:S3:EGA-MODE10:CONTRACT:FAIL\n");
    return 1;
}
