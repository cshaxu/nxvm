...
static type_status core_machine_port_probe_read(C_VOID *owner, lib_u16 port,
    lib_u32 *out_value)
{
...
static type_status core_machine_port_probe_write(C_VOID *owner, lib_u16 port,
    lib_u32 value)
{
    core_machine_port_probe_state *state =
        (core_machine_port_probe_state *)owner;
    ...
    core_machine_port_probe_state *port_state)
{
    ...
    C_INT failed = out_machine == LIB_NULL || port_state == LIB_NULL;
