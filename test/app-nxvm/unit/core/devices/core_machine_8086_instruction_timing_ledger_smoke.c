...
static C_INT timing_8086_test_baseline(C_VOID)
{
    ...
    static const lib_u8 mov_ax_es[] = { 0x8cu, 0xc0u };
    static const lib_u8 xchg_register[] = { 0x87u, 0xc1u };
    static const lib_u8 mov_immediate[] = { 0xb8u, 0x34u, 0x12u };
...
static C_INT timing_8086_test_memory(C_VOID)
{
    ...
    static const lib_u8 read_odd[] = { 0x8bu, 0x0eu, 0x01u, 0x10u };
    static const lib_u8 read_override[] = { 0x26u, 0x8bu, 0x0eu, 0x00u, 0x10u };
    static const lib_u8 read_indexed[] = { 0x8bu, 0x8bu, 0x00u, 0x10u };
    static const lib_u8 lock_add_memory[] = {
        0xf0u, 0x01u, 0x06u, 0x00u, 0x10u
    };
    static const lib_u8 moffs_read_odd[] = { 0xa1u, 0x01u, 0x10u };
    static const lib_u8 moffs_write_odd[] = { 0xa3u, 0x01u, 0x10u };
    static const lib_u8 esc_memory_odd[] = {
...
static C_INT timing_8086_test_alu_and_cmp_forms(C_VOID)
{
    ...
    for (index = 0u; index < sizeof(alu_bases); ++index) {
        lib_u8 group = index;
        lib_u8 base = alu_bases[index];
        lib_u8 register_register[] = { (lib_u8)(base + 3u), 0xc1u };
        lib_u8 register_memory[] = {
            (lib_u8)(base + 3u), 0x06u, 0x00u, 0x10u
        };
        lib_u8 memory_register[] = {
            (lib_u8)(base + 1u), 0x06u, 0x00u, 0x10u
        };
        lib_u8 register_immediate[] = {
            0x81u, (lib_u8)(0xc0u | (group << 3u)), 0x01u, 0x00u
        };
        lib_u8 memory_immediate[] = {
            0x81u, (lib_u8)(0x06u | (group << 3u)), 0x00u, 0x10u,
            0x01u, 0x00u
        };
        lib_u8 accumulator_immediate[] = {
            (lib_u8)(base + 5u), 0x01u, 0x00u
        };
    ...
    return timing_8086_case((const lib_u8[]){ 0x3bu, 0xc1u }, 2u,
        1u, 3u) || timing_8086_case((const lib_u8[]){
            0x3bu, 0x06u, 0x00u, 0x10u }, 4u, 1u, 15u) ||
        timing_8086_case((const lib_u8[]){
            0x39u, 0x06u, 0x00u, 0x10u }, 4u, 1u, 15u) ||
        timing_8086_case((const lib_u8[]){ 0x81u, 0xf8u, 0x01u, 0x00u },
            4u, 1u, 4u) || timing_8086_case((const lib_u8[]){
            0x81u, 0x3eu, 0x00u, 0x10u, 0x01u, 0x00u }, 6u, 1u, 16u) ||
        timing_8086_case((const lib_u8[]){ 0x3du, 0x01u, 0x00u },
            3u, 1u, 4u);
}
...
static C_INT timing_8086_test_primary_remaining_forms(C_VOID)
{
    ...
    static const lib_u8 test_register_immediate[] = {
        0xf7u, 0xc0u, 0x01u, 0x00u
    };
    static const lib_u8 test_memory_immediate[] = {
        0xf7u, 0x06u, 0x00u, 0x10u, 0x01u, 0x00u
    };
    static const lib_u8 test_accumulator[] = { 0xa9u, 0x01u, 0x00u };
    static const lib_u8 inc_register[] = { 0x40u };
    static const lib_u8 dec_register[] = { 0x48u };
    static const lib_u8 inc_byte_register[] = { 0xfeu, 0xc0u };
    static const lib_u8 dec_byte_register[] = { 0xfeu, 0xc8u };
    static const lib_u8 inc_memory[] = { 0xffu, 0x06u, 0x00u, 0x10u };
    static const lib_u8 dec_memory[] = { 0xffu, 0x0eu, 0x00u, 0x10u };
    static const lib_u8 not_register[] = { 0xf7u, 0xd0u };
    static const lib_u8 neg_register[] = { 0xf7u, 0xd8u };
    static const lib_u8 not_memory[] = { 0xf7u, 0x16u, 0x00u, 0x10u };
    static const lib_u8 neg_memory[] = { 0xf7u, 0x1eu, 0x00u, 0x10u };
    static const lib_u8 xchg_ax_register[] = { 0x91u };
    static const lib_u8 xchg_memory[] = { 0x87u, 0x06u, 0x00u, 0x10u };
    static const lib_u8 mov_memory_immediate[] = {
...
static C_INT timing_8086_test_segment_and_pointer_transfers(C_VOID)
{
    ...
    static const lib_u8 sreg_from_register[] = { 0x8eu, 0xc0u };
    static const lib_u8 sreg_from_memory[] = { 0x8eu, 0x06u, 0x00u, 0x10u };
    static const lib_u8 lds_memory[] = { 0xc5u, 0x1eu, 0x00u, 0x10u };
    static const lib_u8 les_memory[] = { 0xc4u, 0x1eu, 0x00u, 0x10u };
    const lib_u16 segment = 0x0800u;
...
static C_INT timing_8086_test_group3_operand_model(C_VOID)
{
    ...
    static const lib_u8 imul_r8[] = { 0xf6u, 0xebu };
    static const lib_u8 imul_r16[] = { 0xf7u, 0xebu };
    static const lib_u8 div_r8[] = { 0xf6u, 0xf3u };
    static const lib_u8 div_r16[] = { 0xf7u, 0xf3u };
    static const lib_u8 idiv_r8[] = { 0xf6u, 0xfbu };
    static const lib_u8 idiv_r16[] = { 0xf7u, 0xfbu };
    static const lib_u8 mul_m8[] = { 0xf6u, 0x26u, 0x00u, 0x10u };
    static const lib_u8 mul_m16[] = { 0xf7u, 0x26u, 0x00u, 0x10u };
    static const lib_u8 imul_m8[] = { 0xf6u, 0x2eu, 0x00u, 0x10u };
    static const lib_u8 imul_m16[] = { 0xf7u, 0x2eu, 0x00u, 0x10u };
    static const lib_u8 div_m8[] = { 0xf6u, 0x36u, 0x00u, 0x10u };
    static const lib_u8 div_m16[] = { 0xf7u, 0x36u, 0x00u, 0x10u };
    static const lib_u8 idiv_m8[] = { 0xf6u, 0x3eu, 0x00u, 0x10u };
    static const lib_u8 idiv_m16[] = { 0xf7u, 0x3eu, 0x00u, 0x10u };
...
static C_INT timing_8086_test_group2_forms(C_VOID)
{
    ...
    for (index = 0u; index < sizeof(extensions); ++index) {
        lib_u8 extension = extensions[index];
        lib_u8 register_one[] = {
            0xd0u, (lib_u8)(0xc0u | (extension << 3u))
        };
        lib_u8 register_cl[] = {
            0xd2u, (lib_u8)(0xc0u | (extension << 3u))
        };
        lib_u8 memory_one[] = {
            0xd1u, (lib_u8)(0x06u | (extension << 3u)), 0x00u, 0x10u
        };
        lib_u8 memory_cl[] = {
            0xd3u, (lib_u8)(0x06u | (extension << 3u)), 0x00u, 0x10u
        };
        timing_8086_state state = { 0u, 0u, 0u };
        core_machine *machine = LIB_NULL;
        C_INT failed = !timing_8086_prepare(&machine, &state);
    ...
    return timing_8086_case((const lib_u8[]){
...
static C_INT timing_8086_test_control_repeat_and_ports(C_VOID)
{
    ...
    static const lib_u8 segment_movsb[] = { 0x26u, 0xa4u };
    static const lib_u8 movsw[] = { 0xa5u };
    static const lib_u8 rep_movsb[] = { 0xf3u, 0xa4u };
    static const lib_u8 segment_rep_movsb[] = { 0x26u, 0xf3u, 0xa4u };
...
static C_INT timing_8086_test_fallback_fault_budget_and_overflow(C_VOID)
{
    ...
    static const lib_u8 maximum[] = { 0x26u, 0x89u, 0x8bu, 0x00u, 0x10u };
    static const lib_u8 nop[] = { 0x90u };
