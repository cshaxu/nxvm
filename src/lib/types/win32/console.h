...
typedef CONSOLE_SCREEN_BUFFER_INFO *lib_win32_pconsole_screen_buffer_info;
typedef CONSOLE_SCREEN_BUFFER_INFOEX *lib_win32_pconsole_screen_buffer_infoex;
...
#define lib_win32_get_console_cursor_info GetConsoleCursorInfo
#define lib_win32_read_console_a ReadConsoleA
#define lib_win32_read_console_input_w ReadConsoleInputW
#define lib_win32_read_console_output_w ReadConsoleOutputW
...
#define lib_win32_write_console_output_character_a WriteConsoleOutputCharacterA
...
#define LIB_WIN32_FROM_LEFT_2ND_BUTTON_PRESSED FROM_LEFT_2ND_BUTTON_PRESSED
