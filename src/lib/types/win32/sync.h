...
#define lib_win32_get_current_thread_id GetCurrentThreadId
#define lib_win32_try_enter_critical_section TryEnterCriticalSection
...
#define lib_win32_interlocked_increment InterlockedIncrement
