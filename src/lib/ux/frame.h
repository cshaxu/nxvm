...
typedef struct ux_frame {
    ...
    type_unsigned_32 graphics_width;
    type_unsigned_32 graphics_height;
    type_signed_32 dirty_left;
    type_signed_32 dirty_top;
    type_signed_32 dirty_right;
    type_signed_32 dirty_bottom;
    type_unsigned_32 graphics_palette[UX_GRAPHICS_PALETTE_ENTRIES];
    type_unsigned_8 graphics_pixels[UX_GRAPHICS_MAX_PIXELS];
} ux_frame;
