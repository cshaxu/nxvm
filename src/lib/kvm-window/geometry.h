...
lib_bool kvm_window_fit_outer_rect(const kvm_window_rect *work, lib_i32 width, lib_i32 height,
    kvm_window_rect *out);
lib_bool kvm_window_fit_client_size(const kvm_window_rect *work, lib_i32 decoration_width,
...
lib_bool kvm_window_fit_aspect_size(lib_i32 width, lib_i32 height, lib_u32 source_width,
