...
lib_bool kvm_window_motion_move(kvm_window_motion *motion, lib_i32 x, lib_i32 y,
    lib_i32 client_width, lib_i32 client_height, lib_u32 content_width,
    lib_u32 content_height, lib_i32 *dx, lib_i32 *dy);
lib_bool kvm_window_motion_scale(kvm_window_motion *motion, lib_i32 x, lib_i32 y,
    lib_i32 client_width, lib_i32 client_height, lib_u32 content_width,
    lib_u32 content_height, lib_i32 *dx, lib_i32 *dy);
#endif
