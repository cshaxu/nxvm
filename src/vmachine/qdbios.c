...
/* special: INT 8 */
	vramVarByte(0xf000, 0x0001) = 0xd8; /* qdx 08 */
...
/* special: INT 09 */
	vramVarByte(0xf000, 0x0004) = 0xd8;
...
/* special: INT 0E */
	vramVarByte(0xf000, 0x0007) = 0xd8;
...
/* special: INT 10 */
	vramVarByte(0xf000, 0x000a) = 0xd8;
...
/* special: INT 11 */
	vramVarByte(0xf000, 0x000d) = 0xd8;
...
/* special: INT 12 */
	vramVarByte(0xf000, 0x0010) = 0xd8;
...
/* special: INT 13 */
	vramVarByte(0xf000, 0x0013) = 0xd8;
...
/* special: INT 14 */
	vramVarByte(0xf000, 0x0016) = 0xd8;
...
/* special: INT 15 */
	vramVarByte(0xf000, 0x0019) = 0xd8;
...
/* special: INT 16 */
	vramVarByte(0xf000, 0x001c) = 0xd8;
...
/* special: INT 17 */
	vramVarByte(0xf000, 0x001f) = 0xd8;
...
/* special: INT 1a */
	vramVarByte(0xf000, 0x0022) = 0xd8;
