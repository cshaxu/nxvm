...
void IO_Write_0087()
{vdmac1.channel[0].page = vcpu.al&0xfe;}
void IO_Write_0083()
{vdmac1.channel[1].page = vcpu.al&0xfe;}
void IO_Write_0081()
{vdmac1.channel[2].page = vcpu.al&0xfe;}
void IO_Write_0082()
{vdmac1.channel[3].page = vcpu.al&0xfe;}
void IO_Write_008B()
{vdmac2.channel[1].page = vcpu.al&0xfe;}
void IO_Write_0089()
{vdmac2.channel[2].page = vcpu.al&0xfe;}
void IO_Write_008A()
{vdmac2.channel[3].page = vcpu.al&0xfe;}
void IO_Write_008F()
{vdmac2.channel[0].page = vcpu.al&0xfe;}
