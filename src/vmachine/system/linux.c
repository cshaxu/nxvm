...
static unsigned char ReverseColor(unsigned char value)
{
	value &= 0x07;
	switch (value) {
	case COLOR_BLACK:   return COLOR_WHITE;   break;
	case COLOR_BLUE:    return COLOR_YELLOW;  break;
	case COLOR_GREEN:   return COLOR_RED;     break;
	case COLOR_CYAN:    return COLOR_MAGENTA; break;
	case COLOR_RED:     return COLOR_GREEN;   break;
	case COLOR_MAGENTA: return COLOR_CYAN;    break;
	case COLOR_YELLOW:  return COLOR_BLUE;    break;
	case COLOR_WHITE:   return COLOR_BLACK;   break;
...
#define send(n) vapiCallBackKeyboardRecvKeyPress(n)
