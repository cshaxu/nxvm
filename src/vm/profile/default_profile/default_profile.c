...
{
    if (default_profile != NULL && default_profile->active) nxvm_baseline_full_pc_run();
}

void nxvm_product_nxvm_default_profile_resume(nxvm_product_nxvm_default_profile *default_profile)
{
    if (default_profile != NULL && default_profile->active) nxvm_baseline_full_pc_resume();
}
...
{
    if (default_profile != NULL && default_profile->active) nxvm_baseline_full_pc_record_stop();
}

void nxvm_product_nxvm_default_profile_request_stop(nxvm_product_nxvm_default_profile *default_profile)
{
    if (default_profile != NULL && default_profile->active) nxvm_baseline_full_pc_request_stop();
}
