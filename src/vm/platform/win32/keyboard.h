#ifndef VM_PLATFORM_WIN32_KEYBOARD_H
#define VM_PLATFORM_WIN32_KEYBOARD_H

#include "type.h"
#include "core/platform/input_interface.h"

typedef type_status (*vm_platform_win32_keyboard_submit)(C_VOID *context,
    const core_platform_input_event *event);

typedef struct vm_platform_win32_keyboard_normalizer {
    type_unsigned_16 pending_high_surrogate;
    type_unsigned_16 recovered_virtual_key;
} vm_platform_win32_keyboard_normalizer;
