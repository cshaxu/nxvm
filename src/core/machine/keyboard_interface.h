...
#define CORE_MACHINE_KEYBOARD_ASYNC_RIGHT_SHIFT (UINT32_C(1) << 0)
#define CORE_MACHINE_KEYBOARD_ASYNC_LEFT_SHIFT  (UINT32_C(1) << 1)
#define CORE_MACHINE_KEYBOARD_ASYNC_CONTROL     (UINT32_C(1) << 2)
#define CORE_MACHINE_KEYBOARD_ASYNC_ALT         (UINT32_C(1) << 3)
#define CORE_MACHINE_KEYBOARD_ASYNC_SCROLL_LOCK (UINT32_C(1) << 4)
#define CORE_MACHINE_KEYBOARD_ASYNC_NUM_LOCK    (UINT32_C(1) << 5)
#define CORE_MACHINE_KEYBOARD_ASYNC_CAPS_LOCK   (UINT32_C(1) << 6)
#define CORE_MACHINE_KEYBOARD_ASYNC_INSERT      (UINT32_C(1) << 7)

#define CORE_MACHINE_KEYBOARD_TOGGLE_SCROLL_LOCK (UINT32_C(1) << 0)
#define CORE_MACHINE_KEYBOARD_TOGGLE_NUM_LOCK    (UINT32_C(1) << 1)
#define CORE_MACHINE_KEYBOARD_TOGGLE_CAPS_LOCK   (UINT32_C(1) << 2)
#define CORE_MACHINE_KEYBOARD_TOGGLE_INSERT      (UINT32_C(1) << 3)
#define CORE_MACHINE_KEYBOARD_TOGGLE_PAUSE       (UINT32_C(1) << 4)
