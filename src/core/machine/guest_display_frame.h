...
#define CORE_MACHINE_GUEST_DISPLAY_MAX_ROWS 25u
#define CORE_MACHINE_GUEST_DISPLAY_MAX_CELLS \
    (CORE_MACHINE_GUEST_DISPLAY_MAX_COLUMNS * CORE_MACHINE_GUEST_DISPLAY_MAX_ROWS)
#define CORE_MACHINE_GUEST_DISPLAY_GRAPHICS_WIDTH 320u
#define CORE_MACHINE_GUEST_DISPLAY_CGA_HIGH_RES_WIDTH 640u
#define CORE_MACHINE_GUEST_DISPLAY_GRAPHICS_HEIGHT 200u
#define CORE_MACHINE_GUEST_DISPLAY_EGA_HIGH_RES_HEIGHT 350u
#define CORE_MACHINE_GUEST_DISPLAY_MAX_PIXELS \
    (CORE_MACHINE_GUEST_DISPLAY_CGA_HIGH_RES_WIDTH * \
        CORE_MACHINE_GUEST_DISPLAY_EGA_HIGH_RES_HEIGHT)
#define CORE_MACHINE_GUEST_DISPLAY_PALETTE_ENTRIES 256u
#define CORE_MACHINE_GUEST_DISPLAY_TEXT_GLYPH_COUNT 256u
#define CORE_MACHINE_GUEST_DISPLAY_TEXT_GLYPH_ROWS 16u
#define CORE_MACHINE_GUEST_DISPLAY_TEXT_GLYPH_BYTES \
    (CORE_MACHINE_GUEST_DISPLAY_TEXT_GLYPH_COUNT * CORE_MACHINE_GUEST_DISPLAY_TEXT_GLYPH_ROWS)

typedef enum core_machine_guest_display_kind {
    CORE_MACHINE_GUEST_DISPLAY_KIND_TEXT,
    CORE_MACHINE_GUEST_DISPLAY_KIND_INDEXED_PIXELS
} core_machine_guest_display_kind;
