...
struct core_machine_guest_input_source {
    STD_ATOMIC_FLAG lock;
    C_INT accepting;
    const core_machine_guest_input_sink *sink;
    C_VOID *context;
};

static C_VOID core_machine_guest_input_source_lock(
    core_machine_guest_input_source *source)
{
...
static C_VOID core_machine_guest_input_source_unlock(
    core_machine_guest_input_source *source)
{
    ...
    const core_machine_guest_input_event *event)
{
    ...
    core_machine_guest_input_source_lock(source);
    ...
    core_machine_guest_input_source_unlock(source);
    return status;
}
