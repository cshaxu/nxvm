...
typedef struct core_machine_fdc_drive_bindings {
    ...
    lib_u16 cylinder_count[CORE_MACHINE_FDC_DRIVE_COUNT];
...
typedef struct core_machine_hdc_task_file_config {
    lib_u16 data_port;
    lib_u16 error_features_port;
    lib_u16 sector_count_port;
    lib_u16 sector_number_port;
    lib_u16 cylinder_low_port;
    lib_u16 cylinder_high_port;
    lib_u16 drive_head_port;
...
typedef struct core_machine_hdc_xebec_config {
    lib_u16 data_port;
    lib_u16 hardware_status_reset_port;
    lib_u16 jumpers_select_port;
    lib_u16 dma_irq_mask_port;
    lib_u8 dma_channel;
...
typedef struct core_machine_hdc_service_config {
    lib_u32 command_ticks;
    lib_u32 next_sector_ticks;
