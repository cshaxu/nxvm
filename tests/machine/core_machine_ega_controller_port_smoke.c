...
static C_INT core_machine_ega_controller_write(t_ram *memory, uint32_t physical,
    uint8_t value)
{
...
static C_INT core_machine_ega_controller_read(t_ram *memory, uint32_t physical,
    uint8_t *value)
{
