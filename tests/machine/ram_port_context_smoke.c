...
C_INT main(C_VOID)
{
    ...
    first_memory.data.flagA20 = NTVDM64_TYPE_TRUE;
    value = 0xa5u;
    result |= core_machine_memory_write_physical(&first_memory, 0x00100000u,
        (ntvdm64_type_virtual_address)&value, 1u) != NTVDM64_STATUS_OK;
    observed = 0u;
    ...
    result |= core_machine_memory_register_mapping(&first_memory, 0xfff00000u,
        0x000f0000u, 16u) != NTVDM64_STATUS_INVALID_ARGUMENT;
