...
C_INT main(C_VOID)
{
    ...
    vm_platform_run_context_initialize(&first, STD_NULL, STD_NULL, STD_NULL, STD_NULL);
    vm_platform_run_context_initialize(&second, STD_NULL, STD_NULL, STD_NULL, STD_NULL);
