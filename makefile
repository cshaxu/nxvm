...
$(TARGET): console.o machine.o main.o utils.o device.o vbios.o vcmos.o vcpu.o vcpuins.o vdma.o vfdc.o vfdd.o vhdc.o vhdd.o vkbc.o vmachine.o vpic.o vpit.o vport.o vram.o vvadp.o aasm32.o dasm32.o debug.o record.o qdcga.o qddisk.o qdkeyb.o qdx.o platform.o linux.o linuxcon.o
	$(CC) -o $(TARGET) console.o machine.o main.o utils.o device.o vbios.o vcmos.o vcpu.o vcpuins.o vdma.o vfdc.o vfdd.o vhdc.o vhdd.o vkbc.o vmachine.o vpic.o vpit.o vport.o vram.o vvadp.o aasm32.o dasm32.o debug.o record.o qdcga.o qddisk.o qdkeyb.o qdx.o platform.o linux.o linuxcon.o $(LIBRARY)


console.o: src/console.c src/utils.h src/global.h src/device/vram.h src/device/vglobal.h src/device/vcpu.h src/device/vfdd.h src/device/vhdd.h src/device/vmachine.h src/device/debug/debug.h src/device/debug/record.h src/device/device.h src/platform/platform.h src/machine.h src/console.h
...
device.o: src/device/device.c src/device/vfdd.h src/device/vglobal.h src/device/vhdd.h src/device/vcpu.h src/device/vpic.h src/device/vpit.h src/device/vdma.h src/device/vfdc.h src/device/vmachine.h src/device/device.h
	$(CC) -c $(CFLAGS) src/device/device.c

vbios.o: src/device/vbios.c src/device/debug/aasm32.h src/device/vram.h src/device/vglobal.h src/device/vmachine.h src/device/vbios.h src/device/device.h src/device/vhdd.h
...
vfdd.o: src/device/vfdd.c src/device/vmachine.h src/device/vglobal.h src/device/vdma.h src/device/vfdd.h
...
vhdd.o: src/device/vhdd.c src/device/vmachine.h src/device/vglobal.h src/device/vdma.h src/device/vhdd.h
...
vmachine.o: src/device/vmachine.c src/device/debug/record.h src/device/debug/debug.h src/device/vport.h src/device/vglobal.h src/device/vram.h src/device/vcpu.h src/device/vbios.h src/device/vpic.h src/device/vpit.h src/device/vcmos.h src/device/vdma.h src/device/vfdc.h src/device/vfdd.h src/device/vhdc.h src/device/vhdd.h src/device/vkbc.h src/device/vvadp.h src/device/qdx/qdx.h src/device/vmachine.h
...
aasm32.o: src/device/debug/aasm32.c src/device/../utils.h src/device/debug/aasm32.h
	$(CC) -c $(CFLAGS) src/device/debug/aasm32.c

dasm32.o: src/device/debug/dasm32.c src/device/../utils.h src/device/debug/dasm32.h
	$(CC) -c $(CFLAGS) src/device/debug/dasm32.c

debug.o: src/device/debug/debug.c src/device/../utils.h src/device/../machine.h src/device/debug/aasm32.h src/device/debug/dasm32.h src/device/debug/debug.h
	$(CC) -c $(CFLAGS) src/device/debug/debug.c

record.o: src/device/debug/record.c src/device/../utils.h src/device/debug/record.h src/device/debug/dasm32.h
	$(CC) -c $(CFLAGS) src/device/debug/record.c

qdcga.o: src/device/qdx/qdcga.c src/device/../platform/platform.h src/device/qdx/qdx.h src/device/qdx/qdcga.h
...
qdkeyb.o: src/device/qdx/qdkeyb.c src/device/../utils.h src/device/qdx/qdx.h src/device/qdx/qdkeyb.h
...
linuxcon.o: src/platform/linux/linuxcon.c src/platform/../utils.h src/platform/../device/device.h src/platform/linux/linuxcon.h
