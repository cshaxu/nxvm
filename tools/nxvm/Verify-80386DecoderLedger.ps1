param(
    [string]$ManifestPath = "docs/nxvm/etc/cpu-timing/t435-s2-80386-timing-manifest.json",
    [string]$InventoryPath = "docs/nxvm/etc/cpu-timing/t435-s8-80386-decoder-inventory.json",
    [string]$LedgerPath = "docs/nxvm/etc/cpu-timing/t435-s1-80386-ledger.md"
)
