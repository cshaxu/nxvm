...
$canonicalStatus=$c.Values|Group-Object -AsHashTable -AsString;if($canonicalStatus['missing-test'].Count -ne 342 -or $canonicalStatus['missing-input'].Count -ne 1069 -or $canonicalStatus.unallocated.Count -ne 20){throw 'Canonical status accounting drifted'}
