...
$decoderSource = Get-Content -Raw -LiteralPath (Join-Path $root "src/core/machine/cpu_instructions.c")
$timingSource = Get-Content -Raw -LiteralPath (Join-Path $root "src/core/machine/cpu_timing_model.c")
