...
$decoderSource = Get-Content -Raw -LiteralPath (Join-Path $root "src/core/core/cpu_instructions.c")
$timingSource = Get-Content -Raw -LiteralPath (Join-Path $root "src/core/core/cpu_timing_model.c")
